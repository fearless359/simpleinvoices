...
(336, 'Make id type for si_log table consistent with all other id settings.', '20230717', 'ALTER TABLE `si_log` MODIFY `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT;', 'fearless359');
