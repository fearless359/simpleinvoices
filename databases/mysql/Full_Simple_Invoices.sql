...
INSERT INTO `si_sql_patchmanager`(`sql_patch_ref`,`sql_patch`,`sql_release`,`sql_statement`) VALUES
 (1,'Create sql_patchmanger table','20060514','CREATE TABLE si_sql_patchmanager (sql_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,sql_patch_ref VARCHAR( 50 ) NOT NULL ,sql_patch VARCHAR( 255 ) NOT NULL ,sql_release VARCHAR( 25 ) NOT NULL ,sql_statement TEXT NOT NULL) ENGINE = MYISAM ')
,(2,'','','')
,(3,'','','')
,(4,'','','')
,(5,'','','')
...
,(198,'','','')
,(199,'','','')
,(200,'Update extensions table','20090529','UPDATE si_extensions SET id = 0 WHERE name = core LIMIT 1')
,(201,'Set domain_id on system defaults table to 1','20090622','UPDATE si_system_defaults SET domain_id = 1')
,(202,'Set extension_id on system defaults table to 1','20090622','UPDATE si_system_defaults SET extension_id = 1')
,(203,'Move all old consulting style invoices to itemized','20090704','UPDATE si_invoices SET type_id = 2 where type_id = 3')
,(204,'','','')
,(205,'','','')
,(206,'','','')
,(207,'','','')
...
,(291,'','','')
,(292,'','','')
,(293,'Add department to the customers','20161004','ALTER TABLE `si_customers` ADD COLUMN `department` VARCHAR(255) NULL AFTER `name`')
,(294,'Add custom_flags table for products.','20180922','')
,(295,'Add net income report.','20180923','')
,(296,'Add past due report.','20180924','')
,(297,'Add User Security enhancement fields and values','20180924','')
,(298,'Add Signature field to the biller table.','20181003','ALTER TABLE `si_biller` ADD `signature` varchar(255) DEFAULT "" NOT NULL COMMENT "Email signature" AFTER `email`')
,(299,'Add check number field to the payment table.','20181003','ALTER TABLE `si_payment` ADD `ac_check_number` varchar(10) DEFAULT "" NOT NULL COMMENT "Check number for CHECK payment types"');
