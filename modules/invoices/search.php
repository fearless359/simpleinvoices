...
<br />
<br />
<b>Search by biller and customer name</b>
<br />
<form action="index.php?module=invoices&view=search" method="post">
  <table width="18%"  border="0">
    ...
    <tr>
      <td><div align="right"><input type="submit" value="Search"></div></td>
      <td>&nbsp;</td>
    </tr>
  </table>
</form>
...
<b>Search by date</b>
<form action="index.php?module=invoices&view=search" method="post">
  <input type="text" class="date-picker" name="startdate" id="date1" value='$startdate' />
  <br />
  <br />
  <input type="text" class="date-picker" name="enddate" id="date2" value='$enddate' />
  <br />
  <br />
