...
try {
    ...
    $smarty->assign('sum_total', $sumTotal);
    $smarty->assign('sum_paid', $sumPaid);
    $smarty->assign('sum_owing', $sumOwing);
} catch (PdoDbException $pde) {
    exit("modules/reports/report_debtors_aging_total.php Unexpected error: {$pde->getMessage()}");
}
