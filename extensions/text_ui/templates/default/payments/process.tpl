<form name="frmpost" action="index.php?module=payments&amp;view=save"
  ...
  <table class="center">
    ...
    <tr>
      ...
      <td>
        <input type="hidden" name="ac_inv_id" value="{$invoice.id|escape:html}" />
    ...
    <tr>
      ...
      <td colspan="5">
        <input type="text" name="ac_amount" size="25" value="{$invoice.owing|escape:html}" />
      </td>
    </tr>
    <tr>
      <td class="details_screen">{$LANG.date_upper}</td>
      <td>
        <input type="text" class="date-picker" name="ac_date" id="date1" value="{$today|escape:html}" />
      </td>
    </tr>
    {/if}
    ...
    <tr>
      <td class="details_screen">
        {$LANG.invoice_id}
        <a href="index.php?module=documentation&amp;view=view&amp;page=help_process_payment_inv_id"
           rel="gb_page_center[450, 450]">
          <img src="{$help_image_path}help-small.png" alt="({$LANG.help})" />
        </a>
      </td>
    ...
    <tr>
      <td class="details_screen">
        {$LANG.details}
        <a href="index.php?module=documentation&amp;view=view&amp;page=help_process_payment_details"
           rel="gb_page_center[450, 450]">
          <img src="{$help_image_path}help-small.png" alt="({$LANG.help})" />
        </a>
      </td>
    ...
    <tr>
      <td class="details_screen">{$LANG.amount}</td>
      <td colspan="5">
        <input type="text" name="ac_amount" size="25" />
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        <select name="ac_payment_type">
          <option selected value="{$defaults.payment_type|escape:html}" style="font-weight: bold">
            {$pt.pt_description|escape:html}
          </option>
