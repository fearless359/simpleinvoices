...
<form name="frmpost" method="post"
      action="index.php?module=invoices&amp;view=email&amp;stage=2&amp;invoice={$smarty.get.invoice}" >
  <div id="top">
  ...
  <table class="center">
    <tr>
      ...
      <td>
        <input type="text" name="email_from" size="50" value="{$biller.email}" />
      </td>
    </tr>
    <tr>
      <td class="details_screen">{$LANG.to}</td>
      <td>
        <input type="text" name="email_to" size="50" value="{$customer.email}" />
      </td>
    </tr>
    <tr>
      <td class="details_screen">BCC</td>
      <td>
        <input type="text" name="email_bcc" size="50" value="{$biller.email}" />
      </td>
    </tr>
    <tr>
      ...
      <td>
        <input type="text" name="email_subject" size="50"
               value="{$preferences.pref_inv_wording} {$invoice.id} from {$biller.name} is attached" />
      </td>
    </tr>
    <tr>
