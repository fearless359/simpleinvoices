{if $smarty.get.action == 'view' }
  <b>
    {$LANG.customer} ::
    <a href="index.php?module=customers&amp;view=details&amp;id={$customer.id}&amp;action=edit">
      {$LANG.edit}
    </a>
  </b>
  <hr />
  ...
  <table width="100%" class="center">
    ...
    <tr class="index_table">
      <td class="details_screen">
        <a href="index.php?module=invoices&amp;view=quick_view&amp;invoice={$invoice.id}">
          {$invoice.id}
        </a>
      </td>
  ...
  <form name="frmpost" method="post"
    ...
    <table>
      ...
      <tr>
        <td class="details_screen">{$LANG.customer_name}</td>
        <td>
          <input type="text" name="name" value="{$customer.name|regex_replace:" /[\\\]/":""}" size="25" />
        </td>
      </tr>
      <tr>
        <td class="details_screen">{$LANG.attention_short}</td>
        <td>
          <input type="text" name="attention" value="{$customer.attention}" size="25" />
        </td>
      </tr>
      <tr>
        <td class="details_screen">{$LANG.street}</td>
