<form name="frmpost" method="post"
  ...
  <b>
    {$LANG.products} ::
    <a href="index.php?module=products&amp;view=details&amp;id={$product.id}&amp;action=edit">
      {$LANG.edit}
    </a>
  </b>
  <hr />
  <table>
    ...
    <tr>
      ...
      <td>{$product.unit_price|siLocal_number:2}</td>
    </tr>
    {if !empty($customFieldLabel.product_cf1)}
    <tr>
      <td class="details_screen">y{$customFieldLabel.product_cf1}</td>
  ...
  {/if}
  {if $smarty.get.action== 'edit' } <b>{$LANG.product_edit}
  </b>
  <hr />
  <table>
    <tr>
    ...
    <tr>
      <td class="details_screen">{$LANG.product_description}</td>
      <td>
        <input type="text" name="description" size="25" value="{$product.description}" />
      </td>
    </tr>
    <tr>
      <td class="details_screen">{$LANG.product_unit_price}</td>
      <td>
        <input type="text" name="unit_price" size="25" value="{$product.unit_price}" />
      </td>
    </tr>
    {if !empty($customFieldLabel.product_cf1)}
    <tr>
      ...
      <td>
        <input type="text" name="custom_field1" size="25" value="{$product.custom_field1}" />
      </td>
    </tr>
    {/if}
    {if !empty($customFieldLabel.product_cf2)}
    <tr>
      <td class="details_screen">{$customFieldLabel.product_cf2}</td>
      <td>
        <input type="text" name="custom_field2" size="25" qvalue="{$product.custom_field2}" />
      </td>
    </tr>
    {/if}
    {if !empty($customFieldLabel.product_cf3)}
    <tr>
      <td class="details_screen">{$customFieldLabel.product_cf3}</td>
      <td>
        <input type="text" name="custom_field3" size="25" value="{$product.custom_field3}" />
      </td>
    </tr>
    {/if}
    {if !empty($customFieldLabel.product_cf4)}
    <tr>
      <td class="details_screen">{$customFieldLabel.product_cf4}</td>
      <td>
        <input type="text" name="custom_field4" size="25" value="{$product.custom_field4}" />
      </td>
    </tr>
    {/if}
    <tr>
      ...
      <td>
        <select name="attribute_1">
          <option value=""></option>
          {foreach from=$attributes item=attribute}
          <option {if $matrix1.attribute_id==$attribute.id} selected{/if} value="{$attribute.id}">
            {$attribute.name}
          </option>
          {/foreach}
        </select>
    ...
    <tr>
      ...
      <td>
        <select name="attribute_2">
          <option value=""></option>
          {foreach from=$attributes item=attribute}
          <option {if $matrix2.attribute_id==$attribute.id} selected{/if} value="{$attribute.id}">
            {$attribute.name}
          </option>
          {/foreach}
        </select>
    ...
    <tr>
      ...
      <td>
        <select name="attribute_3">
          <option value=""></option>
          {foreach from=$attributes item=attribute}
          <option {if $matrix3.attribute_id==$attribute.id} selected{/if} value="{$attribute.id}">
            {$attribute.name}
          </option>
          {/foreach}
        </select>
