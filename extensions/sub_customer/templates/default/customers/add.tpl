        ...
        <div class="si_form">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="street_address2" value="{if isset($smarty.post.street_address2)}{$smarty.post.street_address2|htmlsafe}{/if}"
                               size="25" tabindex="40"/>
                    </td>
                </tr>
                <tr>
                    <th>{$LANG.city}</th>
                    <td>
                        <input type="text" name="city" value="{if isset($smarty.post.city)}{$smarty.post.city|htmlsafe}{/if}"
                               size="25" tabindex="50"/>
                    </td>
                </tr>
                <tr>
                    <th>{$LANG.state}</th>
                    <td>
                        <input type="text" name="state" value="{if isset($smarty.post.state)}{$smarty.post.state|htmlsafe}{/if}"
                               size="25" tabindex="60"/>
                    </td>
                </tr>
                <tr>
                    <th>{$LANG.zip}</th>
                    <td>
                        <input type="text" name="zip_code" value="{if isset($smarty.post.zip_code)}{$smarty.post.zip_code|htmlsafe}{/if}"
                               size="25" tabindex="70"/>
                    </td>
                </tr>
                <tr>
                    <th>{$LANG.country}</th>
                    <td>
                        <input type="text" name="country" value="{if isset($smarty.post.country)}{$smarty.post.country|htmlsafe}{/if}"
                               size="50" tabindex="80"/>
                    </td>
                </tr>
                <tr>
                    <th>{$LANG.phone}</th>
                    <td>
                        <input type="text" name="phone" value="{if isset($smarty.post.phone)}{$smarty.post.phone|htmlsafe}{/if}"
                               size="25" tabindex="90"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="mobile_phone" value="{if isset($smarty.post.mobile_phone)}{$smarty.post.mobile_phone|htmlsafe}{/if}"
                               size="25" tabindex="100"/>
                    </td>
                </tr>
                <tr>
                    <th>{$LANG.fax}</th>
                    <td>
                        <input type="text" name="fax" value="{if isset($smarty.post.fax)}{$smarty.post.fax|htmlsafe}{/if}"
                               size="25" tabindex="110"/>
                    </td>
                </tr>
                <tr>
                    <th>{$LANG.email}</th>
                    <td>
                        <input type="text" name="email" value="{if isset($smarty.post.email)}{$smarty.post.email|htmlsafe}{/if}"
                               size="25" class="validate[required,custom[email]]" tabindex="120"/>
                    </td>
                </tr>
                <tr>
                        ...
                        {else}
                            <select name="parent_customer_id" tabindex="170">
                                ...
                                {foreach from=$parent_customers item=customer}
                                    <option {if isset($defaultCustomerID) && $customer.id == $defaultCustomerID} selected {/if} value="{if isset($customer.id)}{$customer.id|htmlsafe}{/if}">
                ...
                {if !empty($customFieldLabel.customer_cf1)}
                    <tr>
                        ...
                        <td>
                            <input type="text" name="custom_field1" value="{if isset($smarty.post.custom_field1)}{$smarty.post.custom_field1|htmlsafe}{/if}"
                                   size="25" tabindex="180"/>
                        </td>
                    </tr>
                {/if}
                {if !empty($customFieldLabel.customer_cf2)}
                    <tr>
                        ...
                        <td>
                            <input type="text" name="custom_field2" value="{if isset($smarty.post.custom_field2)}{$smarty.post.custom_field2|htmlsafe}{/if}"
                                   size="25" tabindex="190"/>
                        </td>
                    </tr>
                {/if}
                {if !empty($customFieldLabel.customer_cf3)}
                    <tr>
                        ...
                        <td>
                            <input type="text" name="custom_field3" value="{if isset($smarty.post.custom_field3)}{$smarty.post.custom_field3|htmlsafe}{/if}"
                                   size="25" tabindex="200"/>
                        </td>
                    </tr>
                {/if}
                {if !empty($customFieldLabel.customer_cf4)}
                    <tr>
                        ...
                        <td>
                            <input type="text" name="custom_field4" value="{if isset($smarty.post.custom_field4)}{$smarty.post.custom_field4|htmlsafe}{/if}"
                                   size="25" tabindex="210"/>
                        </td>
                    </tr>
                {/if}
                <tr>
                    ...
                    <td>
                        <!--
                        <textarea name="notes" class="editor" tabindex="220">{*if isset($smarty.post.notes)*}{*$smarty.post.notes|outhtml*}{*/if*}</textarea>
                        -->
                        <input name="notes" id="notes" {if isset($smarty.post.notes)}value="{$smarty.post.notes|outhtml}"{/if} type="hidden">
                        <trix-editor input="notes" tabindex="220"></trix-editor>
                    </td>
                </tr>
                <tr>
                    <th>{$LANG.enabled}</th>
                    <td>{html_options name=enabled options=$enabled selected=1 tabindex=230}</td>
                </tr>
            </table>
