                ...
                <table>
                    {if !empty($customFieldLabel.product_cf1)}
                        <tr>
                            ...
                            <td>
                                <select name="custom_field1" class="si_input" tabindex="60">
                                    <option value=""></option>
                                    {foreach from=$product_group item=pg}
                                        <option value="{if isset($pg.name)}{$pg.name|htmlSafe}{/if}" {if $pg.name == $product.custom_field1}selected{/if}>{$pg.name|htmlSafe}</option>
                                    {/foreach}
                                </select>
                            </td>
                        </tr>
