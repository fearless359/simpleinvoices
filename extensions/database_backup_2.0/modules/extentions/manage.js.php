...
*/
			...
			colModel : [
				...
				{display: '{/literal}{$LANG.name}{literal}', name : 'name', width : 16 * percentage_width, sortable : true, align: 'left'},
				{display: '{/literal}{$LANG.description}{literal}', name : 'description', width : 55 * percentage_width, sortable : true, align: 'left'},
