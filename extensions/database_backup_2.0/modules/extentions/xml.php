...
//		$xml .= "<cell><![CDATA[".$light[$row['enabled']].$plugin[$row['registered']]."]]></cell>";				
		if ($row['enabled']==$LANG['enabled']) {
			$xml .= "<cell name='enabled'><![CDATA[
					<a id='enabled-".$row['id']."' data-id='".$row['id']."' class='makepcdisabled'><img src='images/common/tick.png' alt='tick' /></a>
				".$plugin[$row['registered']]."]]></cell>";
		} else {
			$xml .= "<cell name='enabled'><![CDATA[
					<a id='disabled-".$row['id']."' data-id='".$row['id']."' class='makepcenabled'><img src='images/common/cross.png' alt='cross' /></a>
				".$plugin[$row['registered']]."]]></cell>";
		}
		$xml .= "</row>";		
	}
