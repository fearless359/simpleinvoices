...
$LANG['custom_fields_uc'] = "Ελεύθερα Πεδία";//1
...
$LANG['date_uc'] = "Καταληκτική Ημερομηνία";//1
$LANG['days'] = "Ημέρες";//1
...
$LANG['fax'] = "Φαξ";//1
$LANG['filter_by_dates_uc'] = "Φίλτρο ανά ημερομηνία";//1
...
$LANG['invoices_uc'] = "Παραστατικά";//1
$LANG['item'] = "Είδος";//1
