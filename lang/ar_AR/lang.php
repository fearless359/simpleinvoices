...
$LANG['add_new_biller'] = "إضافة مفوتر جديد";//1
$LANG['add_new_invoice'] = "إضافة فاتورة جديدة";//1
$LANG['add_new_payment_type'] = "طريقة دفع جديده";//1
$LANG['add_new_preference'] = "اعدادات الفاتورة";//1
$LANG['add_new_product'] = "اضافة منتج جديد";//1
$LANG['add_new_row'] = "صف جديد";//1
$LANG['add_new_tax_rate'] = "اضافة معدل ضريبة جديد";//1
...
$LANG['custom_fields_uc'] = "تخصيص حقول";//1
...
$LANG['faqs_how'] ="كيف يمكنني إنشاء فاتورة ؟";//0
$LANG['faqs_need'] ="ماذا أحتاج لكي أبدأ بعمل الفواتير ؟";//0
$LANG['faqs_type'] ="What are the different types of invoices?";//0
$LANG['faqs_what'] ="What is SimpleInvoices?";//0
$LANG['fax'] = "فاكس";//0
...
$LANG['item'] = "Item";//0
$LANG['itemised'] = "Itemized";//0
$LANG['itemised_style'] = "Itemized style";//0
...
$LANG['system_preferences'] = "SI Defaults";//0
$LANG['tax'] = "Tax";//0
