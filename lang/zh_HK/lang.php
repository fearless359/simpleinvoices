...
$LANG['help_reports_xsl'] = "<b>報告錯誤</b><br />如果您收到一個“OOOOPS，這裡有個錯誤。”當你試圖在系統運行報告，這意味著你的PHP版本沒有安裝正確的擴展名(或啟用)錯誤。<br /><br />如果您運行的Windows服務器和使用WAMP5請參閱網頁上的簡單維基發票有關如何解決這個信息https://simpleinvoices.group/howto<br /><br />如果您運行的Unix / Linux和PHP5，請確保您有XSL擴展，並安裝在你的php.ini文件中激活。在Ubuntu的GNU / Linux，請安裝用於PHP5的PHP的XSL包<br /><br />如果您使用PHP4，請確保您的PHP有Sablotron的支持 '--enable-xslt'<br /><br />注：因為他們的服務器的設置如果你在SourceForge上報告的演示環境中使用這個系統將無法正常工作。";//1
