...
$LANG['backup_done'] = "您的數據已經備份到文件 %s, 你現在可以繼續正常使用SimpleInvoices.";//1
$LANG['backup_howto'] = "如需備份你的SimpleInvoices數據庫，請點擊下面的鏈接";//1
...
$LANG['faqs_what'] ="SimpleInvoices是什麼?";//1
$LANG['fax'] = "傳真";//1
$LANG['filter_by_dates_uc'] = "以時間篩選";//1
$LANG['filters'] = "篩選";//1
...
$LANG['help_backup_database'] = "為備份正常運作，網頁伺服器的用戶(希望你正在運行Apache)必須具有讀/寫權限database_backups目錄中的SimpleInvoices文件夾<br/><br/>另外，如果你有多餘的偏執狂(像我一樣:) )關於數據的，我建議使用phpMyAdmin。此備份腳本應該工作正常，但如果需要“企業級”的備份可靠性phpMyAdmin會好一些<br/><br/>注：如果您在演示環境在SourceForge上使用SimpleInvoices，備份不會正常運作因為這是他們服務器的設定。 ";//1
...
$LANG['help_reports_xsl'] = "<b>報告錯誤</b><br />如果您收到一個“OOPS，這裡有個錯誤。”當你試圖在系統運行報告，這意味著你的PHP版本沒有安裝正確的擴展名(或啟用)錯誤。<br /><br />如果您運行的Windows服務器和使用WampServer請參閱網頁上的簡單維基發票有關如何解決這個信息https://simpleinvoices.group/howto<br /><br />如果您運行的Unix / Linux和PHP5，請確保您有XSL擴展，並安裝在你的php.ini文件中激活。在Ubuntu的GNU / Linux，請安裝用於PHP5的PHP的XSL包<br /><br />如果您使用PHP4，請確保您的PHP有Sablotron的支持 '--enable-xslt'<br /><br />注：因為他們的服務器的設置如果你在SourceForge上報告的演示環境中使用這個系統將無法正常工作。";//1
$LANG['help_required_field'] = "這是必填字段。您必須在此字段中輸入一個值，然後才能保存表單<br /><br />";//1
$LANG['help_si_help'] = "幫助";//1
$LANG['help_simple_invoices'] = "本系統是一個基本的進銷存系統的設計與簡單性和功能的初衷。照顧小企業和家庭用戶的需求。<br /><br />欲了解更多信息，請參閱<a href='https://simpleinvoices.group' target='_blank'> <b>SimpleInvoices SimpleInvoicesKnowledge Base - Menu</b></a>";//1
