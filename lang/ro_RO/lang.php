...
$LANG['backup_done'] = "Your database has now been backed up to the file %s, you can now continue using SimpleInvoices as normal.";//0
$LANG['backup_howto'] = "To make a backup of your SimpleInvoices database click the below link";//0
...
$LANG['custom_fields_uc'] = "Campuri Personalizate";//1
...
$LANG['faqs_what'] = "Ce este SimpleInvoices?";//1
$LANG['fax'] = "Fax";//1
$LANG['filter_by_dates_uc'] = "Filter by Dates";//0
...
$LANG['prepare_simple_invoices'] = "Pregatire SimpleInvoices pentru utilizare";//1
$LANG['price'] = "Pret";//1
...
$LANG['thank_you'] = "Va multumim ca ati ales SimpleInvoices!";//1
...
$LANG['upgrading_simple_invoices'] = "Actualizare SimpleInvoices";//1
$LANG['user_add'] = "Adauga Utilizator";//1
$LANG['users'] = "Utilizatori";//1
$LANG['using_simple_invoices'] = "Utilizare SimpleInvoices";//1
$LANG['value'] = "Value";//0
