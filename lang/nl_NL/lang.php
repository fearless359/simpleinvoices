...
$LANG['about'] = "Over SimpleInvoices";//1
...
$LANG['backup_done'] = "Uw database backup is opgeslagen naar het bestand %s, u kunt verder gaan met het gebruik van SimpleInvoices zoals normaal.";//1
$LANG['backup_howto'] = "Om een backup te maken van uw SimpleInvoices database, klik op de link hier onder";//1
...
$LANG['credit_card_number_encrypted'] = "Het credit card nummer is gecodeerd en is wordt niet weergegeven in SimpleInvoices";//1
...
$LANG['faqs_what'] = "Wat is SimpleInvoices?";//1
$LANG['fax'] = "Fax";//1
...
$LANG['help_blog'] = "SimpleInvoices Blog";//0
...
$LANG['help_si_help'] = "SimpleInvoices Help";//0
...
$LANG['help_text'] = "<b>Warning</b><br /><br />Please backup your SimpleInvoices database before running the database update, just in case anything bad happens.<br /><br />To backup the database, select 'Backup Database' from the Options menu, or use phpMyAdmin(if you have this installed) to back up the database.";//0
...
$LANG['no_customers'] = "There have been no customers created.  Click the 'Add New Customer' button above to create one";//0
...
$LANG['no_invoices'] = "There have been no invoices created. Click the 'New Invoice' button above to create an invoice";//0
...
$LANG['prepare_simple_invoices'] = "Maak SimpleInvoices gereed voor gebruik";//1
$LANG['price'] = "Prijs";//1
...
$LANG['si_defaults'] = "Systeem voorkeuren";//1
$LANG['tax'] = "BTW";//1
...
$LANG['title_module_system_defaults'] = "Settings / SI Defaults";//0
...
$LANG['upgrading_simple_invoices'] = "Nieuwere versie van SimpleInvoices installeren";//1
$LANG['user_add'] = "Gebruiker toevoegen";//1
$LANG['users'] = "Gebruikers";//1
$LANG['using_simple_invoices'] = "SimpleInvoices gebruiken";//1
$LANG['value'] = "Waarde";//1
$LANG['view'] = "Bekijk";//1
