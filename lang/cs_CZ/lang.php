...
$LANG['amount_uc'] = "Celkem k úhradě";//1
...
$LANG['custom_fields_uc'] = "Volitelná pole";//1
...
$LANG['faqs_what'] ="Co je SimpleInvoices?";//1
$LANG['fax'] = "Fax";//1
$LANG['filter_by_dates_uc'] = "Filtry podle data";//1
...
$LANG['prepare_simple_invoices'] = "Připrava SimpleInvoices pro použití";//1
...
$LANG['upgrading_simple_invoices'] = "Aktualizace SimpleInvoices";//1
$LANG['user_add'] = "Add User";//1
$LANG['users'] = "Users";//1
$LANG['using_simple_invoices'] = "Používání SimpleInvoices";//1
