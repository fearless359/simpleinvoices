...
$LANG['custom_fields_uc'] = "Personalizzazjoniet";//1
...
$LANG['faqs_what'] = "X'inhu SimpleInvoices?";//1
$LANG['fax'] = "Fax";//1
...
$LANG['prepare_simple_invoices'] = "Ipprepara SimpleInvoices għall-użu";//1
$LANG['price'] = "Price";//0
