...
$LANG['account_info'] = "Información da conta";//1
$LANG['actions'] = "Accións";//1
$LANG['add'] = "Engadir";//1
$LANG['add_biller'] = "Engadir un emisor";//1
$LANG['add_customer'] = "Engadir un cliente";//1
$LANG['add_invoice_item'] = "Engadir un elemento na factura";//1
$LANG['add_invoice_preference'] = "Engadir unha preferencia na factura";//1
$LANG['add_item'] = "Engadir un elemento";//1
$LANG['add_new_biller'] = "Engadir un novo emisor";//1
$LANG['add_new_invoice'] = "Engadir unha nova factura";//1
$LANG['add_new_payment_type'] = "Engadir un novo tipo de pago";//1
$LANG['add_new_preference'] = "Engadir unha preferencia de facturación";//1
$LANG['add_new_product'] = "Engadir un novo produto";//1
$LANG['add_new_row'] = "Engadir unha nova fila";//1
$LANG['add_new_tax_rate'] = "Engadir unha nova taxa de impostos";//1
$LANG['add_payment_type'] = "Engadir un tipo de pagamento";//1
$LANG['add_product'] = "Engadir un";//1
$LANG['add_product_attribute'] = "Add Product Attribute";//1
$LANG['add_product_value'] = "Add Product Value";//1
$LANG['add_tax_rate'] = "Engadir a taxa de impostos";//1
$LANG['address_uc'] = "Enderezo";//1
$LANG['address_city'] = "Enderezo: cidade";//1
$LANG['address_country'] = "Enderezo: país";//1
$LANG['address_state'] = "Enderezo: provincia";//1
$LANG['address_street'] = "Enderezo: rúa";//1
$LANG['address_zip'] = "Enderezo: código postal";//1
$LANG['age'] = "Idade";//1
$LANG['aging'] = "Antigüidade";//1
$LANG['all'] = "Todo";//1
$LANG['all_reports'] = "Todos os informes";//1
$LANG['amount_uc'] = "Cantidade";//1
$LANG['as_template'] = "como modelo";//1
$LANG['attention_short'] = "Attn.";//1
$LANG['attribute'] = "Atributo";//1
$LANG['attribute_short'] = "Atrib.";//1
$LANG['back'] = "Back";//1
...
$LANG['biller_edit'] = "Editar o emisor";//1
$LANG['biller_id'] = "ID do emisor";//1
$LANG['biller_name'] = "Nome do emisor";//1
$LANG['biller_sales'] = "Ventas do emisor";//1
$LANG['biller_sales_by_customer_totals'] = "Ventas do emisor por cliente - Totais";//1
$LANG['biller_sales_total'] = "Ventas do emisor - Totais";//1
...
$LANG['confirm_delete'] = "Confirma que quere eliminalo";//1
$LANG['consulting'] = "Consulting";//1
$LANG['consulting_style'] = "Consulting style";//1
$LANG['cost_uc'] = "Custo";//1
$LANG['country'] = "País";//1
$LANG['create_invoice'] ="Crear unha factura";//1
$LANG['credit_card_details'] = "Detalles da tarxeta de crédito";//1
$LANG['credit_card_expiry_month'] = "Mes no que caduca a tarxeta de crédito";//1
$LANG['credit_card_expiry_year'] = "Ano no que caduca a tarxeta de crédito";//1
$LANG['credit_card_holder_name'] = "Nome do titular da tarxeta de crédito";//1
$LANG['credit_card_number'] = "Número da tarxeta de crédito";//1
$LANG['credit_card_number_encrypted'] = "O número da tarxeta de crédito foi cifrado e non se amosará en SimpleInvoices";//1
$LANG['credit_card_number_new'] = "Número novo da tarxeta de crédito";//1
$LANG['credits'] = "Credits";//1
$LANG['currency_code'] = "Código da moeda";//1
$LANG['currency_sign'] = "Símbolo da moeda";//1
$LANG['currency_sign_non_dollar'] = "Euro, Pound, signo \$ non lea este";//1
...
$LANG['date'] = "data";//1
$LANG['date_created'] = "Data de creación";//1
...
$LANG['default_biller'] = "Emisor predeterminado";//1
$LANG['default_customer'] = "Cliente predeterminado";//1
$LANG['default_inv_template'] = "Modelo de factura predeterminado";//1
$LANG['default_invoice_preference'] = "Preferencia de factura predeterminada";//1
$LANG['default_number_items'] = "Número predeterminado de elementos de liña";//1
$LANG['default_payment_type'] = "Tipo de pago predeterminado";//1
$LANG['default_tax'] = "Imposto predeterminado";//1
...
$LANG['delete_line_item'] = "Eliminar este elemento de liña";//1
...
$LANG['description_uc'] = "Descrición";//1
...
$LANG['email'] = "Correo";//1
$LANG['email_bcc'] = "Correo CCA (con copia agochada) ";//1
...
$LANG['export_xls_tooltip'] = "para unha folla de cálculo como";//1
$LANG['extensionsUc'] = "Extensións";//1
$LANG['faqs'] = "Preguntas frecuentes";//1
$LANG['faqs_how'] ="Como crear facturas?";//1
$LANG['faqs_need'] ="Que necesito para comezar a facturar?";//1
$LANG['faqs_type'] ="Cales son os distintos tipos de facturas?";//1
$LANG['faqs_what'] ="Que é SimpleInvoices?";//1
$LANG['fax'] = "Fax";//1
$LANG['filter_by_dates_uc'] = "Filtrar por datas";//1
$LANG['filters'] = "Filtros";//1
$LANG['financial_status'] = "Estado financieiro";//1
$LANG['for'] = "para";//1
...
$LANG['help_blog'] = "Blog de SimpleInvoices";//1
$LANG['help_community_forums'] = "Foros da comunidade";//1
...
$LANG['help_logging'] = "To log actions performed in SimpleInvoices enable this option. This creates a log in the database of what actions were performed.<br /><br />Note: At the moment the only way to view the log is in the database, soon we'll incorparte a nice log viewer into SimpleInvoices.";//1
...
$LANG['help_si_help'] = "Axuda de SimpleInvoices";//1
...
$LANG['hide_details'] = "Agochar os detalles";//1
$LANG['home'] = "Home";//1
$LANG['id'] = "ID";//1
$LANG['ie_10_for_10'] = "* p.ex. 10 para 10%";//1
$LANG['include_online_payment'] = "Include online payment";//1
$LANG['included'] = "incluído";//1
$LANG['insert_biller'] = "Inserir o emisor";//1
$LANG['insert_customer'] = "Inserir o cliente";//1
$LANG['insert_payment_type'] = "Inserir o tipo de pagamento";//1
$LANG['insert_preference'] = "Inserir a preferencia";//1
$LANG['insert_product'] = "Inserir o produto";//1
$LANG['insert_product_attribute'] = "Insert Product Attribute";//1
$LANG['insert_product_value'] = "Insert Product Value";//1
$LANG['insert_tax_rate'] = "Inserir a porcentaxe do imposto";//1
$LANG['installationUc'] = "Instalación";//1
$LANG['inv'] = "Factura";//1
$LANG['inv_consulting'] = " - Analizado";//1
$LANG['inv_itemized'] = " - Desagregado";//1
$LANG['inv_pref'] = "Preferencia da factura";//1
$LANG['inv_pref_short'] = "Pref.";//1
$LANG['inv_total'] = " - Total";//1
$LANG['inventory'] = "Inventario";//1
$LANG['invoice'] = "Factura";//1
$LANG['invoice_create'] = "Crear unha factura";//1
$LANG['invoice_detail_heading'] = "Detalle da cabeceira da factura";//1
$LANG['invoice_detail_line'] = "Detalle da liña da factura";//1
$LANG['invoice_footer'] = "Rodapé da factura";//1
$LANG['invoice_heading'] = "Cabeceira da factura";//1
$LANG['invoice_id'] = "ID da Factura";//1
$LANG['invoice_listings'] = "Listado de facturas";//1
$LANG['invoice_number'] = "Número da factura";//1
...
$LANG['manage_billers'] = "Administrar os emisores";//1
$LANG['manage_custom_fields'] = "Administrar os  campos personalizados";//1
$LANG['manage_customers'] = "Administrar os clientes";//1
$LANG['manage_data'] ="Administrar os seus datos";//1
$LANG['manage_existing_invoice'] ="Administrar as facturas existentes";//1
$LANG['manage_invoice_preferences'] = "Administrar as preferencias das facturas";//1
$LANG['manage_invoices'] = "Administrar as facturas";//1
$LANG['manage_payment_types'] = "Administrar os tipos de pagamento";//1
$LANG['manage_payments'] = "Administrar os pagamentos";//1
$LANG['manage_preferences'] = "Administrar as preferencias";//1
$LANG['manage_product_attributes'] = "Manage Product Attributes";//1
$LANG['manage_product_values'] = "Manage Product Value";//1
$LANG['manage_products'] = "Administrar os produtos";//1
$LANG['manage_tax_rates'] = "Administrar as porcentaxes de impostos";//1
