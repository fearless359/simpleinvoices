...
$LANG['backup_done'] = "您的数据已经备份到文件 %s, 你现在可以继续正常使用SimpleInvoices.";//1
$LANG['backup_howto'] = "如需备份你的SimpleInvoices数据库，请点击下面的链接";//1
...
$LANG['faqs_what'] ="SimpleInvoices是什么?";//1
$LANG['fax'] = "传真";//1
$LANG['filter_by_dates_uc'] = "以时间筛选";//1
$LANG['filters'] = "筛选";//1
