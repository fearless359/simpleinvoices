...
$LANG['add_customer'] = "Vevő Hozzáadása";//1
$LANG['add_invoice_item'] = "Add Invoice Item";//1
$LANG['add_invoice_preference'] = "Add Invoice Preference";//1
$LANG['add_item'] = "Termék Hozzóadása";//1
$LANG['add_new_biller'] = "Add New Biller";//1
$LANG['add_new_invoice'] = "Új Számla Hozzáadása";//1
$LANG['add_new_payment_type'] = "Új Fizetési Mód Hozzáadása";//1
$LANG['add_new_preference'] = "Add Invoice Preference";//1
$LANG['add_new_product'] = "Új Termék Hozzáadása";//1
$LANG['add_new_row'] = "Új Sor Hozzáadása";//1
$LANG['add_new_tax_rate'] = "Új Adókulcs Hozzáadása";//1
$LANG['add_payment_type'] = "Fizetési Mód Hozzáadása";//1
$LANG['add_product'] = "Termék Hozzáadása";//1
$LANG['add_product_attribute'] = "Add Product Attribute";//1
$LANG['add_product_value'] = "Add Product Value";//1
$LANG['add_tax_rate'] = "Adókulcs Hozzáadása";//1
$LANG['address_uc'] = "Cím";//1
$LANG['address_city'] = "Cím: Város";//1
$LANG['address_country'] = "Cím: Ország";//1
$LANG['address_state'] = "Cím: Állam";//1
$LANG['address_street'] = "Cím: Utca";//1
$LANG['address_zip'] = "Cím: Irányítószám";//1
$LANG['age'] = "Kor";//1
$LANG['aging'] = "Aging";//1
$LANG['all'] = "Összes";//1
$LANG['all_reports'] = "Összes Riport";//1
$LANG['amount_uc'] = "Összeg";//1
$LANG['as_template'] = "as template";//1
$LANG['attention_short'] = "Attn.";//1
$LANG['attribute'] = "Atribútum";//1
$LANG['attribute_short'] = "Attr";//1
$LANG['back'] = "Vissza";//1
$LANG['backup_database'] = "Adatbázis Mentés";//1
$LANG['backup_database_now'] = "ADATBÁZIS MENTÉSE MOST";//1
$LANG['backup_done'] = "Az adatbázis elmentésre került a %s fájlba, most már folytathatja a SimpleInvoices Használatát";//1
...
$LANG['cost_uc'] = "Költség";//1
$LANG['country'] = "Ország";//1
$LANG['create_invoice'] ="Számla létrehozás";//1
$LANG['credit_card_details'] = "Kredit Kártya adatok";//1
$LANG['credit_card_expiry_month'] = "Credit card expiry month";//1
$LANG['credit_card_expiry_year'] = "Credit card expiry year";//1
$LANG['credit_card_holder_name'] = "Kredit kártya tulajdonos neve";//1
$LANG['credit_card_number'] = "Kredit Kártyaszám";//1
$LANG['credit_card_number_encrypted'] = "The credit card number has been encrypted and is not displayed in SimpleInvoices";//1
$LANG['credit_card_number_new'] = "Új Kredit Kártyaszám";//1
