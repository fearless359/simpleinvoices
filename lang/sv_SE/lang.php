...
$LANG['custom_fields_uc'] = "Egendefinierade Fält";//1
...
$LANG['fax'] = "Fax";//1
$LANG['filter_by_dates_uc'] = "sortera efter datum";//1
...
$LANG['help_simple_invoices'] = "SimpleInvoices är ett simpelt faktureringssystem designat med enkelhet och funktionalitet i tanken. Det tillgodoser behoven för små organisationer och hemma användare.<br /><br />För mera information vänligen hänvisa till SimpleInvoices webbsida: <a href='https://simpleinvoices.group' target='_blank'><b>SimpleInvoices SimpleInvoicesKnowledge Base</b></a>";//1
