...
$LANG['add_new_expense'] = "Add New Expense";//0
$LANG['add_new_expense_account'] = "Add New Expense Account";//0
...
$LANG['add_new_user'] = "Add your new user here; specifying the User Name, Password and Email fields. After adding the new user, go to the edit screen to enable it and set the other user settings.";//0
...
$LANG['copied_from'] = "Copied from";//0
$LANG['company_logo'] = "Company Logo";//0
...
$LANG['cron_delete_failure'] = "Recurrence could not be deleted, <br /> you will be redirected to the Manage Recurrences page";//0
$LANG['cron_delete_success'] = "Recurrence successfully deleted, <br /> you will be redirected to the Manage Recurrences page";//0
...
$LANG['default_invoice'] = "Default Invoice";//0
...
$LANG['delete_failed'] = "Delete request failed, <br /> you will be redirected momentarily";//0
$LANG['delete_success'] = "Delete request succeeded, <br /> you will be redirected momentarily";//0
...
$LANG['draft'] = "Draft";//1
$LANG['due'] = "Due";//1
$LANG['duplicate_product_value'] = "Duplicate products-values record exists for specified attribute and value.";//0
$LANG['duplicate_tax_description'] = "Tax rate with this description already exists.";//0
$LANG['edit'] = "Edit";//1
...
$LANG['expenses'] = "Expenses";//0
$LANG['expense_accounts'] = "Expense Accounts";//0
$LANG['extensions'] = "Extensions";//1
$LANG['failure'] = "Your request was NOT processed,<br />you will be redirected to the Manage page momentarialy.<br/> Check error log for additional information.";//0
...
$LANG['help_customer_email'] = "Enter the email for this customer. It must conform to email formatting standards and is used to deliver invoices via email to the customer.";//0
...
$LANG['help_default_biller'] = "Select the biller that will be used as the default on new invoices.";//0
$LANG['help_default_customer'] = "Select the customer that will be used as the default on new invoices.";//0
$LANG['help_default_invoice'] = "Enter the number of an invoice that will be used by default, as a template for generating new invoices. Note that this setting will be overridden by the default invoice set for a Customer.";//0
$LANG['help_default_invoice_preference'] = "Select the invoice type you prefer to be set when an invoice is created. The preference can be changed before the new invoice is submitted.";//0
...
$LANG['help_default_number_items'] = "Enter the number of invoice item slots to show for entry on a new invoice. Note that all the slots do not need to be filled in, and more can be added prior to submitting the new invoice if the default number is not sufficient.";//0
$LANG['help_default_payment_type'] = "Select the payment type that will show by default for new payments. This value can be altered prior to submission.";//0
$LANG['help_default_tax'] = "Select the tax that will be used as the default on new invoices.";//0
...
$LANG['help_expense'] = "Select option to Enable/Disable use of the SimpleInvoices Expense maintenance feature.";//0
$LANG['help_expense_accounts'] = "Enter the name of the expense account.";//0
...
$LANG['help_inventory'] = "Select option to Enable/Disable use of the SimpleInvoices Inventory maintenance feature.";//0
...
$LANG["help_language"] = "Specify the language that will be use by SimpleInvoices.";//0
...
$LANG['help_product_attributes'] = "<b>ENABLE</b> if product attributes are to be used. <b>DISABLE</b> if not.";//0
...
$LANG['help_street2'] = "The field 'Street Address 2' is used when the street address is either too long to fit one one line or it contains multiple parts.<br /><br />ie. The street address '325 South Main Street, Apt #1' can be separated into <br /><br />Street: 325 S Main St<br />Street Address 2: Apt #1";//0
...
$LANG['help_taxes_per_line_item'] = "Specify the number of taxes to display per invoice line item. Should be kept to 3 or less.";//0
...
$LANG['last_invoice'] = "Last Invoice";//0
...
$LANG['no_expenses'] = "No expenses have been created. Click the 'Add New Expense' button above to create one";//0
$LANG['no_expense_accounts'] = "No expense accounts have been created. Click the 'Add New Expense Account' button above to create one";//0
...
$LANG['no_product_attributes'] = "There are no product attribute records.  Click the 'Add Product Attribute' button above to create one.";//0
$LANG['no_product_values'] = "There are no product value records.  Click the 'Add Product Value' button above to create one";//0
...
$LANG['sales_by_representative'] = "Sales by Representative";//0
$LANG['sales_report'] = "Sales Report";//1
$LANG['sales_representative'] = "Sales Representative";//0
$LANG['sales_summary'] = "Sales Summary";//0
...
$LANG['save_expense_account_failure'] = "Something went wrong, please try saving the Expense Account again";//0
$LANG['save_expense_account_success'] = "Expense Account successfully saved, <br /> you will be redirected to the Expense Accounts page";//0
$LANG['save_expense_failure'] = "Something went wrong, please try saving the Expense again";//0
$LANG['save_expense_success'] = "Expense successfully saved, <br /> you will be redirected to the Expenses page";//0
...
$LANG['save_product_attributes_failure'] = "Something went wrong, please try saving the product attribute again";//0
$LANG['save_product_attributes_success'] = "Product attribute successfully saved, <br /> you will be redirected to the Manage Product Attributes page";//0
...
$LANG['save_product_value_failure'] = "Something went wrong, please try saving the product value again";//0
$LANG['save_product_value_success'] = "Product value successfully saved, <br /> you will be redirected to the Manage Product Attributes page";//0
...
$LANG['selection_period'] = "Selection for the period";//0
...
$LANG['street_address'] = "Street Address";//0
...
$LANG['success'] = "Your request was processed successfully, <br /> you will be redirected to the Manage page momentarialy";//0
