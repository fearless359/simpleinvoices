...
$LANG['custom_fields_uc'] = "Campos Campo personalizados";//1
...
$LANG['faqs_what'] ="¿Que es SimpleInvoices?";//1
$LANG['fax'] = "Fax";//1
$LANG['filter_by_dates_uc'] = "Filtras por fecha";//1
...
$LANG['inv_itemized'] = "- por elementos";//1
...
$LANG['no_items'] = "No items encontrados";//0
...
$LANG['otherUc'] = "Otro";//1
$LANG['owing_uc'] = "Deudor";//1
$LANG['page'] = "Pagina";//1
$LANG['paid'] = "Pagado";//1
$LANG['password'] = "Contraseña";//1
$LANG['payment_uc'] = "Pagos";//1
...
$LANG['paymentsgateway_api_id'] = "ID API PaymentsGateway.com ";//0
...
$LANG['products_sold_total'] = "Productos vendidos - Total";//0
