...
$LANG['backup_done'] = "Pembuatan cadangan database ke nama file %s telah berhasil, anda dapat melanjutkan penggunaan SimpleInvoices seperti biasa ";//1
$LANG['backup_howto'] = "Klik link di bawah ini untuk membuat cadangan database SimpleInvoices";//1
...
$LANG['credit_card_number_encrypted'] = "Nomor kartu kredit telah dienkripsi dan tidak diperlihatkan di SimpleInvoices";//1
...
$LANG['faqs_what'] ="Apakah SimpleInvoices itu?";//1
$LANG['fax'] = "Fax";//1
$LANG['filter_by_dates_uc'] = "Filter berdasarkan tanggal";//1
...
$LANG['help_invoice_create'] = "Membuat nota cukup mudah. Ketika data biller dan pelanggan telah terinput ke SimpleInvoices, cukup dengan memilih tipe nota dari menu 'Nota +', masukkan informasi dan klik 'Simpan Nota'.";//1
...
$LANG['help_si_help'] = "Bantuan SimpleInvoices";//1
