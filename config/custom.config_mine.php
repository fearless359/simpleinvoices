...
; - refer https://simpleinvoices.group for all options
...
database.params.username            = rrowfbbw_dbAdmin
database.params.password            = '#dbAdmin7of72of2'
database.params.dbname              = rrowfbbw_simple_invoices
...
version.name                        = 2018.3.0
version.update_date                 = 20181105

local.locale                        = en_US
local.precision                     = 2

email.host                          = server40.web-hosting.com
email.smtp_auth                     = true
email.username                      = mail@fearlesstechcomp.com
email.password                      = '#Veda7of72of2Louise'
email.smtpport                      = 26
email.secure                        = TLS
email.ack                           = false
...
[staging : production]
database.params.dbname              = rrowfbbw_simple_invoices_staging
database.params.username            = devuser
database.params.password            = devsecret

[dev : production]
database.params.dbname              = rrowfbbw_simple_invoices_dev
