...
class CaseStmt {
     ...
     * @param boolean $endStmt (Optional) Defaults to <b>false</b>. Specify <b>true</b> when the last
     ...
     * @param array|null $keypairs (Optional) Parameter exists for function call compatibility
     *        with other <i>PdoDb</i> class SQL build objects. 
     * @return string Formatted <b>CASE</b> statement this criterion.
     * @throws PdoDbException
     */
    public function build($keypairs=null): string
    {
        if (!$this->endStmt) {
