...
class CustomFlags
{
     ...
     * @throws PdoDbException
     */
    public static function getCustomFlag($associated_table, $flg_id, $domain_id = '')
    {
        global $LANG, $pdoDb;
     ...
     * @throws PdoDbException
     */
    public static function getCustomFlags($domain_id = '')
    {
        return self::getCustomFlagsQualified('A', $domain_id);
    }
     ...
     *
     */
    public static function getCustomFlagsQualified($qualifier, $domain_id = '')
    {
        global $LANG, $pdoDb;
        $domain_id = domain_id::get($domain_id);
     ...
     * @throws PdoDbException
     */
    public static function updateCustomFlags($associated_table, $flg_id, $field_label, $enabled, $clear_flags, $field_help, $domain_id = '')
    {
        if (is_bool($enabled)) {
