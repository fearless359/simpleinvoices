...
<div class="flex__area margin__bottom-2">
    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.companyLogo}:
        ...
        <div class="margin__left-0-5">{$defaults.company_logo}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.companyNameItemLabel}:
        ...
        <div class="margin__left-0-5">{$defaults.company_name_item}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.defaultBiller}:
        ...
        <div class="margin__left-0-5">{$defaultBiller.name}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.defaultCustomer}:
        ...
        <div class="margin__left-0-5">{$defaultCustomer.name}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.defaultInvoice}:
        ...
        <div class="margin__left-0-5">{$defaults.default_invoice}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.defaultInvoicePreference}:
        ...
        <div class="margin__left-0-5">{$defaultPreference.pref_description}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.defaultInvTemplate}:
        ...
        <div class="margin__left-0-5">{$defaults.template}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.defaultNumberItems}:
        ...
        <div class="margin__left-0-5">{$defaults.line_items}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.defaultPaymentType}:
        ...
        <div class="margin__left-0-5">{$defaultPaymentType}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.defaultTax}:
        ...
        <div class="margin__left-0-5">{$defaultTax.tax_description}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.delete}:
        ...
        <div class="margin__left-0-5">{if $defaultDelete == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.displayDepartment}:
        ...
        <div class="margin__left-0-5">{if $defaultDisplayDepartment == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.expenseUc}:
        ...
        <div class="margin__left-0-5">{if $defaultExpense == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.inventory}:
        ...
        <div class="margin__left-0-5">{if $defaultInventory == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.invoiceDescriptionOpen}:
        ...
        <div class="margin__left-0-5">{if $defaultInvoiceDescriptionOpen == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.invoiceDisplayDays}:
        ...
        <div class="margin__left-0-5">{$defaults.invoice_display_days}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.language}:
        ...
        <div class="margin__left-0-5">{$defaultLanguage}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.logging}:
        ...
        <div class="margin__left-0-5">{if $defaultLogging == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.passwordMinLength}:
        ...
        <div class="margin__left-0-5">{$defaultPasswordMinLength}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.numberOfTaxesPerLineItem}:
        ...
        <div class="margin__left-0-5">{$defaults.tax_per_line_item}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.passwordLower}:
        ...
        <div class="margin__left-0-5">{if $defaultPasswordLower == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.passwordNumber}:
        ...
        <div class="margin__left-0-5">{if $defaultPasswordNumber == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.passwordSpecial}:
        ...
        <div class="margin__left-0-5">{if $defaultPasswordSpecial == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.passwordUpper}:
        ...
        <div class="margin__left-0-5">{if $defaultPasswordUpper == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.productAttributes}:
        ...
        <div class="margin__left-0-5">{if $defaultProductAttributes == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.paymentDeleteDays}:
        ...
        <div class="margin__left-0-5">{$defaults.payment_delete_days}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.productGroupsUc}:
        ...
        <div class="margin__left-0-5">{if $defaultProductGroups == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.sessionTimeout}:
        ...
        <div class="margin__left-0-5">{$defaults.session_timeout}</div>
    </div>

    <div class="flex__container flex__start">
        <div class="bold margin__right-1">{$LANG.subCustomer}:
        ...
        <div class="margin__left-0-5">{if $defaultSubCustomer == $smarty.const.ENABLED}{$LANG.enabled}{else}{$LANG.disabled}{/if}</div>
    </div>
