        ...
        <div class="grid__area">
            {if $smarty.get.op === "pay_selected_invoice"}
                <div class="grid__container grid__head-10">
                    ...
                    <div class="cols__9-span-1 align__text-right">{$invoice.total|utilNumber:$invoice.precision:$invoice.locale}</div>
                </div>
                <div class="grid__container grid__head-10">
                    ...
                    <div class="cols__9-span-1 align__text-right">{$invoice.paid|utilNumber:$invoice.precision:$invoice.locale}</div>
                </div>
                <div class="grid__container grid__head-10">
                    ...
                    <div class="cols__9-span-1 align__text-right underline">{$invoice.owing|utilNumber:$invoice.precision:$invoice.locale}</div>
                </div>
                <div class="grid__container grid__head-10">
