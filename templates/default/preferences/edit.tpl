...
<form name="frmpost" method="POST" id="frmpost"
    ...
    <div class="flex__area">
        <div class="flex__container flex__start">
            <label for="descId" class="margin__right-1">{$LANG.descriptionUc}:
        ...
        <div class="flex__container flex__start">
            ...
            <div class="grid__container grid__head-checkbox margin__left-0">
                <input type="checkbox" name="include_online_payment[]" id="onlinePymt1Id" value='paypal' tabindex="80"
                       {if in_array("paypal",explode(",", $preference.include_online_payment)) }checked{/if}>
                <label for="onlinePymt1Id" class="margin__left-1-5 margin__top-0">{$LANG.paypal}</label>
                <input type="checkbox" name="include_online_payment[]" id="onlinePymt2Id"
                       class="margin__top-0-5" tabindex="81" value='eway_merchant_xml'
                       {if in_array("eway_merchant_xml",explode(",", $preference.include_online_payment)) }checked{/if}>
                <label for="onlinePymt2Id" class="margin__left-1-5 margin__left-0-5">{$LANG.ewayMerchantXml}</label>
                <input type="checkbox" name="include_online_payment[]" id="onlinePymt3Id"
                       class="margin__top-0-5" tabindex="82" value='paymentsgateway'
                       {if in_array("paymentsgateway",explode(",", $preference.include_online_payment)) }checked{/if}>
                <label for="onlinePymt3Id" class="margin__left-1-5 margin__top-0-5">{$LANG.paymentsGateway}</label>
            </div>
        </div>
        <div class="flex__container flex__start">
        ...
        <div class="flex__container flex__start">
            ...
            <input type="text" name='pref_inv_payment_line1_name' id="invPaymentLine1NameId" size="50" tabindex="100"
        ...
        <div class="flex__container flex__start">
            ...
            <input type="text" name='pref_inv_payment_line1_value' id="invPaymentLine1ValueId" size="50" tabindex="110"
        ...
        <div class="flex__container flex__start">
            ...
            <input type="text" name='pref_inv_payment_line2_name' id="invPaymentLine2NameId" size="50" tabindex="120"
        ...
        <div class="flex__container flex__start">
            ...
            <input type="text" name='pref_inv_payment_line2_value' id="invPaymentLine2ValueId" size="50" tabindex="130"
        ...
        <div class="flex__container flex__start">
            <label for="startingIndexId" class="margin__left-2 margin__right-1" id="startingIndexIdLabel">{$LANG.startingNumber}:
                <img class="tooltip" title="{$LANG.helpStartingNumber}" src="{$helpImagePath}help-small.png" alt=""/>
            </label>
            <input type="text" name="startingIndexId" id="startingIndexId" tabindex="155" value="{$startingId}">
            <span class="bold margin__left-1 margin__right-2 margin__top-0-5" id="nextIndexIdLabel">{$LANG.nextNumber}:</span>
            <span id="nextIndexId" class="margin__top-0-5">{$nextId}</span>
        </div>
        <div class="flex__container flex__start">
