...
<form name="frmpost" method="POST" id="frmpost"
    ...
    <div class="grid__area">
        <div class="grid__container grid__head-10">
            <label for="descId" class="cols__2-span-3 align__text-right margin__right-1">{$LANG.descriptionUc}:
                <img class="tooltip" title="{$LANG.requiredField} {$LANG.helpInvPrefDescription}" src="{$helpImagePath}required-small.png" alt=""/>
            </label>
            <input type="text" name='pref_description' id="descId" class="cols__5-span-1" required
                   size="50" tabindex="10"
        ...
        <div class="grid__container grid__head-10">
            ...
            <input type="text" name='pref_currency_sign' id="currencySignId" class="cols__5-span-1" size="15" tabindex="20"
        ...
        <div class="grid__container grid__head-10">
            ...
            <input type="text" name='currency_code' id="currencyCodeId" class="cols__5-span-1" size="15" tabindex="30"
        ...
        <div class="grid__container grid__head-10">
            ...
            <input type="text" name='pref_inv_heading' id="invHeadingId" class="cols__5-span-2" size="50" tabindex="40"
        ...
        <div class="grid__container grid__head-10">
            ...
            <input type="text" name='pref_inv_wording' id="invWordingId" class="cols__5-span-2" size="50" tabindex="50"
        ...
        <div class="grid__container grid__head-10">
            ...
            <input type="text" name='pref_inv_detail_heading' id="invDetailHeadingId" class="cols__5-span-2"
                   size="50" tabindex="60"
        ...
        <div class="grid__container grid__head-10">
            ...
            <input type="text" name='pref_inv_detail_line' id="invDetailLineId" class="cols__5-span-6"
                   size="75" tabindex="70"
        ...
        <div class="grid__container grid__head-10">
            ...
            <input type="text" name='pref_inv_payment_method' id="invPaymentMethodId"
                   class="cols__5-span-3" size="50" tabindex="90"
        ...
        <div class="grid__container grid__head-10">
            ...
            <input type="text" name='pref_inv_payment_line1_name' id="invPaymentLine1NameId"
                   class="cols__5-span-3" size="50" tabindex="100"
        ...
        <div class="grid__container grid__head-10">
            ...
            <input type="text" name='pref_inv_payment_line1_value' id="invPaymentLine1ValueId"
                   class="cols__5-span-3" size="50" tabindex="110"
        ...
        <div class="grid__container grid__head-10">
            ...
            <input type="text" name='pref_inv_payment_line2_name' id="invPaymentLine2NameId"
                   class="cols__5-span-3" size="50" tabindex="120"
        ...
        <div class="grid__container grid__head-10">
            ...
            <input type="text" name='pref_inv_payment_line2_value' id="invPaymentLine2ValueId"
                   class="cols__5-span-3" size="50" tabindex="130"
        ...
        <div class="grid__container grid__head-10">
            ...
            <select name="index_group" id="groupId" class="cols__5-span-1" tabindex="150" onchange="checkIndexGroup()">
                {if $useThisPref}
            ...
            <label for="startingIndexId" class="cols__6-span-2 bold align__text-right margin__right-1" id="startingIndexIdLabel" style="display:none">{$LANG.startingNumber}:
                <img class="tooltip" title="{$LANG.helpStartingNumber}" src="{$helpImagePath}help-small.png" alt=""/>
            </label>
            <input type="text" name="startingIndexId" id="startingIndexId" class="cols__8-span-1 align__text-left" tabindex="155"
                   value="{$startingId}" style="display:none;">
            <span class="cols__6-span-2 bold align__text-right margin__right-2 margin__top-0-5" id="nextIndexIdLabel" style="display:inline">{$LANG.nextNumber}: </span>
            <span id="nextIndexId" class="cols__8-span-1 align__text-left margin__top-0-5" style="display:inline">{$nextId}</span>
        </div>
        <div class="grid__container grid__head-10">
            ...
            <select name="set_aging" id="setAgingId" class="cols__5-span-1" tabindex="160">
        ...
        <div class="grid__container grid__head-10">
            ...
            <select name="pref_enabled" id="enabledId" class="cols__5-span-1" tabindex="170">
        ...
        <div class="grid__container grid__head-10">
            ...
            <select name="language" id="languageId" class="cols__5-span-1" tabindex="180">
        ...
        <div class="grid__container grid__head-10">
            ...
            <select name="locale" id="localeId" class="cols__5-span-1" tabindex="190">
                {foreach $localeList as $locale}
