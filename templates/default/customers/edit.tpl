...
<form name="frmpost" method="POST" id="frmpost"
    ...
    <div class="flex__area">
        ...
        <div class="flex__container flex__start">
            ...
            <input type="text" name="phone" id="phoneId" tabindex="90" size="12" placeholder="{$PLACEHOLDERS['tel']}"
        ...
        {if !empty($customer.credit_card_number_masked)}
            <div class="flex__container flex__start">
                <div class="bold margin__right-1">{$LANG.creditCardNumber}:
                    <img class="tooltip" title="{$LANG.helpCreditCardNumberMask}" src="{$helpImagePath}info.png" alt=""/>
                </div>
                <div>{$customer.credit_card_number_masked}</div>
            </div>
        {/if}
        <div class="flex__container flex__start">
        ...
        {if $invoiceCount > 0}
            <div class="flex__container flex__start">
                <label for="defaultInvoiceId" class="margin__right-1">{$LANG.defaultInvoice}:
        ...
        {if $subCustomerEnabled}
            {if $isParent}
                <div class="flex__container flex__start">
                    <div class="bold margin__right-1">{$LANG.parentOfCustomers}:
...
*}
        ...
        {if !empty($customFieldLabel.customer_cf1)}
            <div class="flex__container flex__start">
                <label for="customField1" class="margin__right-1">{$customFieldLabel.customer_cf1|htmlSafe}:
        ...
        {if !empty($customFieldLabel.customer_cf3)}
            <div class="flex__container flex__start">
                <label for="customField3" class="margin__right-1">{$customFieldLabel.customer_cf3|htmlSafe}:
                    <img class="tooltip" title="{$LANG.helpCustomFields}" src="{$helpImagePath}help-small.png" alt=""/>
                </label>
        ...
        {if !empty($customFieldLabel.customer_cf4)}
            <div class="flex__container flex__start">
                <label for="customField4" class="margin__right-1">{$customFieldLabel.customer_cf4|htmlSafe}:
                    <img class="tooltip" title="{$LANG.helpCustomFields}" src="{$helpImagePath}help-small.png" alt=""/>
                </label>
