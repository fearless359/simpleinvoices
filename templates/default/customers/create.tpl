    ...
    <form name="frmpost" method="POST" id="frmpost" action="index.php?module=customers&amp;view=create">
        <div class="flex__area">
            <div class="flex__container flex__start">
                <label for="name" class="margin__right-1">{$LANG.customerName}:
            ...
            <div class="flex__container flex__start">
                <label for="department" class="margin__right-1">{$LANG.customerDepartment}:</label>
            ...
            <div class="flex__container flex__start">
                <label for="attentionId" class="margin__right-1">{$LANG.customerContact}:
            ...
            <div class="flex__container flex__start">
                <label for="zipCodeId" class="margin__right-1">{$LANG.zip}:</label>
            ...
            <div class="flex__container flex__start">
                <label for="creditCardNumberId" class="margin__right-1">{$LANG.creditCardNumber}:
            ...
            <div class="flex__container flex__start">
                <label for="creditCardHolderNameId" class="margin__right-1">{$LANG.creditCardHolderName}:
            ...
            <div class="flex__container flex__start">
                <label for="creditCardExpiryMonthId" class="margin__right-1">{$LANG.creditCardExpiryMonth}:
            ...
            <div class="flex__container flex__start">
                <label for="creditCardExpiryYearId" class="margin__right-1">{$LANG.creditCardExpiryYear}:
            ...
            <div class="flex__container flex__start">
                <label for="parentCustomerId" class="margin__right-1">{$LANG.parentCustomer}:
            ...
            {if !empty($customFieldLabel.customer_cf1)}
                <div class="flex__container flex__start">
                    <label for="customField1Id" class="margin__right-1">{$customFieldLabel.customer_cf1|htmlSafe}:
            ...
            {if !empty($customFieldLabel.customer_cf2)}
                <div class="flex__container flex__start">
                    <label for="customField2Id" class="margin__right-1">{$customFieldLabel.customer_cf2|htmlSafe}:
                        <img class="tooltip" title="{$LANG.helpCustomFields}" src="{$helpImagePath}help-small.png" alt=""/>
                    </label>
            ...
            {if !empty($customFieldLabel.customer_cf3)}
                <div class="flex__container flex__start">
                    <label for="customField3Id" class="margin__right-1">{$customFieldLabel.customer_cf3|htmlSafe}:
                        <img class="tooltip" title="{$LANG.helpCustomFields}" src="{$helpImagePath}help-small.png" alt=""/>
                    </label>
            ...
            {if !empty($customFieldLabel.customer_cf4)}
                <div class="flex__container flex__start">
                    <label for="customField4Id" class="margin__right-1">{$customFieldLabel.customer_cf4|htmlSafe}:
                        <img class="tooltip" title="{$LANG.helpCustomFields}" src="{$helpImagePath}help-small.png" alt=""/>
                    </label>
