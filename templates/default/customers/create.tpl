    ...
    <form name="frmpost" method="POST" id="frmpost" action="index.php?module=customers&amp;view=create">
        <div class="si_form">
            <table>
                ...
                {if !empty($customFieldLabel.customer_cf2)}
                    <tr>
                        ...
                        <td><input type="text" name="custom_field2" class="si_input" size="25" tabindex="180"
                ...
                {if !empty($customFieldLabel.customer_cf3)}
                    <tr>
                        ...
                        <td><input type="text" name="custom_field3" class="si_input" size="25" tabindex="190"
                ...
                {if !empty($customFieldLabel.customer_cf4)}
                    <tr>
                        ...
                        <td><input type="text" name="custom_field4" class="si_input" size="25" tabindex="200"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <trix-editor input="notes" class="si_input" tabindex="210"></trix-editor>
                    </td>
                </tr>
                <tr>
                    <th class="details_screen">{$LANG.enabled}: </th>
                    <td>{html_options name=enabled class=si_input options=$enabled selected=$customer.enabled tabindex=220}</td>
                </tr>
            </table>
            <div class="si_toolbar si_toolbar_form">
                ...
                <a href="index.php?module=customers&amp;view=manage" class="negative" tabindex="240">
