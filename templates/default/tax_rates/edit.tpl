...
<form name="frmpost" method="POST" id="frmpost"
    ...
    <div class="flex__area">
        <div class="flex__container flex__start">
            <label for="descId" class="margin__right-1" tabindex="-1">{$LANG.descriptionUc}:</label>
        ...
        <div class="flex__container flex__start">
            ...
            {html_options name=type class="magrin__left-1 checkTaxPercentage" id="typeId" options=$types selected=$tax.type tabindex=21}
            <span class="margin__left-1 margin__top-0-5">{$LANG.ie10For10}</span>
        </div>
        <div class="flex__container flex__start">
