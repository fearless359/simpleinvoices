...
<form name="frmpost" method="POST" id="frmpost"
    ...
    <div class="grid__area">
        <div class="grid__container grid__head-10">
            <label for="descId" class="cols__2-span-2 align__text-right" tabindex="-1">{$LANG.descriptionUc}:&nbsp;</label>
            <input type="text" name="tax_description" id="descId" class="cols__4-span-4" required size="25" tabindex="10"
                   value="{if isset($tax.tax_description)}{$tax.tax_description|htmlSafe}{/if}"/>
        </div>
        <div class="grid__container grid__head-10">
            <label for="percentageId" class="cols__2-span-2 align__text-right margin__right-1">{$LANG.rateUc}:
            ...
            <input type="text" name="tax_percentage" id="percentageId" tabindex="20" size="10" required
                   class="cols__4-span-2 validate-number" value="{$tax.tax_percentage|utilNumber}"/>
            {html_options name=type class="cols__6-span-1 magrin__left-1" options=$types selected=$tax.type tabindex=21}
            <span class="cols__7-span-2 margin__left-1">{$LANG.ie10For10}</span>
        </div>
        <div class="grid__container grid__head-10">
            <label for="enabledId" class="cols__2-span-2 align__text-right">{$LANG.enabled}:&nbsp;</label>
            <select name="tax_enabled" id="enabledId" class="cols__4-span-1" tabindex="30">
