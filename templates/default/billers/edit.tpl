...
<div class="form__container">
    <form name="frmpost" method="POST" id="frmpost"
        ...
        {if !empty($customFieldLabel.biller_cf2)}
            <div class="row">
                <div class="col__25">
                    <label for="customField2Id">{$customFieldLabel.biller_cf2|htmlSafe}:
                        <img class="tooltip" title="{$LANG.helpCustomFields}" src="{$helpImagePath}help-small.png"
                             alt=""/>
                    </label>
                </div>
        ...
        <div class="row">
            <div class="col__100">
                <input name="footer" id="footer" {if isset($biller.footer)}value="{$biller.footer|htmlSafe}"{/if}
                       type="hidden">
        ...
        <div class="row">
            <div class="col__100">
                <input name="notes" id="notes" {if isset($biller.notes)}value="{$biller.notes|htmlSafe}"{/if}
                       type="hidden">
