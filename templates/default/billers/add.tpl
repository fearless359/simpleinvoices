    ...
    <table>
      <tr>
        ...
        <td><input type="text" name="name"
                   value="{if isset($smarty.post.name)}{$smarty.post.name|htmlsafe}{/if}" size="25" id="name"
                   class="validate[required]" /></td>
      </tr>
      <tr>
        <th>{$LANG.street}</th>
        <td><input type="text" name="street_address"
                   value="{if isset($smarty.post.street_address)}{$smarty.post.street_address|htmlsafe}{/if}" size="25" /></td>
      </tr>
      <tr>
        <th>{$LANG.street2}
          <a class="cluetip" href="#"
        ...
        <td><input type="text" name="street_address2"
                   value="{if isset($smarty.post.street_address2)}{$smarty.post.street_address2|htmlsafe}{/if}" size="25" /></td>
      </tr>
      <tr>
        <th>{$LANG.city}</th>
        <td><input type="text" name="city"
                   value="{if isset($smarty.post.city)}{$smarty.post.city|htmlsafe}{/if}" size="25" /></td>
      </tr>
      <tr>
        <th>{$LANG.state}</th>
        <td><input type="text" name="state"
                   value="{if isset($smarty.post.state)}{$smarty.post.state|htmlsafe}{/if}" size="25" /></td>
      </tr>
      <tr>
        <th>{$LANG.zip}</th>
      ...
      <tr>
        ...
        <td>
          <textarea class="editor" name="footer"
                    rows="4" cols="50">{if isset($smarty.post.footer)}{$smarty.post.footer|htmlsafe}{/if}</textarea>
        </td>
      </tr>
      <tr>
        <th>{$LANG.notes}</th>
        <td>
          <textarea class="editor" name="notes"
                    rows="8" cols="50">{if isset($smarty.post.notes)}{$smarty.post.notes|htmlsafe}{/if}</textarea>
        </td>
      </tr>
      <tr>
        <th>{$LANG.enabled}</th>
