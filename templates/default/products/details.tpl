            ...
            <table>
                ...
                {if $defaults.product_attributes}
                    ...
                    {foreach from=$attributes item=attribute}
                        ...
                        {if $attribute.enabled == '1' || $product.attribute_decode[$i] == 'true'}
                            <tr>
                                <td></td>
                                <th class="details_screen product_attribute">
                                    <input type="checkbox" disabled="disabled" name="attribute{$i}"
                                            {if $product.attribute_decode[$i] == 'true'} checked {/if} value="true"/>
                                    {$attribute.name}
                                </th>
                            </tr>
                        {/if}
                    ...
                    {foreach from=$cflgs item=cflg}
                        ...
                        <tr>
                            ...
                            <td style="float:left;margin-left:auto;width:10px;">
                                <input type="checkbox" name="custom_flags_{$cflg.flg_id}" {if substr($product.custom_flags,$i,1) == '1'} checked {/if} value="1"/>
                            </td>
                        </tr>
                    {/foreach}
                    {if $defaults.product_attributes}
