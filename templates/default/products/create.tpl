            ...
            <div class="delay__display margin__top-1-5" id="tabs_customer">
                ...
                <div id="section-1" class="fragment width_100">
                        ...
                        <div class="row">
                            <div class="col__20">
                                <label for="customField1"
                                       class="margin__right-1">{$customFieldLabel.product_cf1|htmlSafe}:
                        ...
                        <div class="row">
                            <div class="col__20">
                                <label for="customField2"
                                       class="margin__right-1">{$customFieldLabel.product_cf2|htmlSafe}:
                                    <img class="tooltip" title="{$LANG.helpCustomFields}"
                                         src="{$helpImagePath}help-small.png" alt=""/>
                                </label>
                            </div>
                    ...
                    {if !empty($customFieldLabel.product_cf3)}
                        <div class="row">
                            <div class="col__20">
                                <label for="customField3"
                                       class="margin__right-1">{$customFieldLabel.product_cf3|htmlSafe}:
                                    <img class="tooltip" title="{$LANG.helpCustomFields}"
                    ...
                    {if !empty($customFieldLabel.product_cf4)}
                        <div class="row">
                            <div class="col__20">
                                <label for="customField4"
                                       class="margin__right-1">{$customFieldLabel.product_cf4|htmlSafe}:
                                    <img class="tooltip" title="{$LANG.helpCustomFields}"
                                         src="{$helpImagePath}help-small.png" alt="help"/>
                                </label>
                            </div>
                            ...
                            <div class="row">
                                <div class="col__5">
                                    <input type="checkbox" name="custom_flags_{$cflg.flg_id}"
                                           id="custom_flags_{$cflg.flg_id}" value="1" tabindex="11{$cflg@index}"/>
                                </div>
                                <div class="col__95">
                                    <label for="custom_flags_{$cflg.flg_id}" style="padding-top: 0">
                            ...
                            <div class="row">
                                <div class="col__5">
                                    <input type="checkbox" name="attribute{$attribute.id}"
                                           ...
                                           value="true" tabindex="12{$attribute@index}"/>
                                </div>
                                <div class="col__95">
                                    <label for="attribute{$attribute.id}"
                                           style="padding-top: 0">{$attribute.name}</label>
                                </div>
                            </div>
                        {/foreach}
                    {/if}
                ...
                <div id="section-2" class="fragment width_100">
                    ...
                    <div class="row">
                        <div class="col__100">
                            <span class="label underline">{$LANG.noteAttributes}</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col__5">
                            <input type="checkbox" name="notes_as_description" id="notesAsDescId" value="true"
                                   tabindex="140"/>
                        </div>
                        <div class="col__95">
