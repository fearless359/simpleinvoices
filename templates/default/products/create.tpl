...
{else}
    <form name="frmpost" method="POST" id="frmpost" action="index.php?module=products&amp;view=create">
        <div class="grid__area">
            <div class="delay__display" id="tabs_customer">
                ...
                <div id="section-1" class="fragment">
                    ...
                    <div class="grid__container grid__head-10">
                        <label for="unitPriceId" class="cols__2-span-2">{$LANG.unitPrice}:</label>
                    ...
                    <div class="grid__container grid__head-10">
                        <label for="enabledId" class="cols__2-span-2">{$LANG.enabled}:</label>
                ...
                <div id="section-3" class="fragment">
                    <div class="grid__container grid__head-10">
                        <label for="notesId" class="cols__2-span-1">{$LANG.notes}:</label>
                    </div>
                    <div class="grid__container grid__head-10">
                        ...
                        <div class="cols__2-span-7">
                            <div class="grid__container grid__head-checkbox">
                                <input type="checkbox" name="notes_as_description" id="notesAsDescId"
                                       class="cols__1-span-1" value="true" tabindex="140"/>
                        ...
                        <div class="cols__2-span-7">
                            <div class="grid__container grid__head-checkbox">
                                <input type="checkbox" name="show_description" id="showDescId"
                                       class="cols__1-span-1" value="true" tabindex="150"/>
        ...
        <div class="align__text-center">
            ...
            <a href="index.php?module=products&amp;view=manage" class="button negative" tabindex="170">
