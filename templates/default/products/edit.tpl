...
<div class="form__container">
    <form name="frmpost" method="POST" id="frmpost"
        ...
        <div class="row">
            <div class="col__20">
                <label for="unitPriceId">{$LANG.unitPrice}:</label>
            </div>
            <div class="col__80">
        ...
        {if $defaults.inventory == $smarty.const.ENABLED}
            ...
            <div class="row">
                <div class="col__20">
                    <label for="reorderLevelId">{$LANG.reorderLevel}:</label>
                </div>
                <div class="col__80">
                    <input type="text" name="reorder_level" id="reorderLevelId" class="validateWholeNumber" size="25"
                           tabindex="40"
        ...
        <div class="row">
            <div class="col__20">
                <label for="defaultTaxId">{$LANG.defaultTax}:</label>
            </div>
            <div class="col__80">
        ...
        {if $defaults.product_groups == $smarty.const.ENABLED}
            <div class="row">
                <div class="col__20">
                    <label for="productGroupId">{$LANG.productGroupUc}:</label>
                </div>
                <div class="col__80">
        ...
        <div class="row">
            <div class="col__20">
                <label for="enabledId">{$LANG.productEnabled}:</label>
            </div>
            <div class="col__80">
        ...
        <div class="delay__display margin__top-1-5" id="tabs_customer">
            <ul>
            ...
            <div id="section-1">
                {if !empty($customFieldLabel.product_cf1)}
                    <div class="row">
                        <div class="col__20">
                            <label for="customField1">{$customFieldLabel.product_cf1|htmlSafe}:
                ...
                {if !empty($customFieldLabel.product_cf2)}
                    <div class="row">
                        <div class="col__20">
                            <label for="customField2">{$customFieldLabel.product_cf2|htmlSafe}:
                                <img class="tooltip" title="{$LANG.helpCustomFields}"
                                     src="{$helpImagePath}help-small.png" alt=""/>
                            </label>
                        </div>
                ...
                {if !empty($customFieldLabel.product_cf3)}
                    <div class="row">
                        <div class="col__20">
                            <label for="customField3">{$customFieldLabel.product_cf3|htmlSafe}:
                                <img class="tooltip" title="{$LANG.helpCustomFields}"
                                     src="{$helpImagePath}help-small.png" alt=""/>
                            </label>
                        </div>
                ...
                {if !empty($customFieldLabel.product_cf4)}
                    <div class="row">
                        <div class="col__20">
                            <label for="customField4">{$customFieldLabel.product_cf4|htmlSafe}:
                                <img class="tooltip" title="{$LANG.helpCustomFields}"
                                     src="{$helpImagePath}help-small.png" alt=""/>
                            </label>
                        </div>
                ...
                {if !empty($cflgs)}
                    <div class="row">
                        <div class="col__100">
                            <span class="label underline">{$LANG.customFlagsUc}</span>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col__5">
                                <input type="checkbox" name="custom_flags_{$cflg.flg_id}"
                                       id="custom_flags_{$cflg.flg_id}Id" tabindex="6{$i}"
                                        {if substr($product.custom_flags,$i,1) == '1'} checked {/if} value="1"/>
                            </div>
                            <div class="col__95">
                                <label for="custom_flags_{$cflg.flg_id}Id" style="padding-top: 0">
                ...
                {if $defaults.product_attributes}
                    <div class="row">
                        <div class="col__100">
                            <span class="label underline">{$LANG.productAttributes}</span>
                        </div>
                    </div>
                    {foreach $attributes as $attribute}
                        ...
                        (isset($product.attribute_decode[$i]) && $product.attribute_decode[$i] == 'true')}
                            <div class="row">
                                ...
                                <div class="col__95">
                                    <label for="attribute{$i}Id" style="padding-top: 0">{$attribute.name}</label>
                                </div>
                            </div>
                        {/if}
                    {/foreach}
            ...
            <div id="section-2">
                ...
                <div class="row">
                    <div class="col__100">
                        <span class="labor underline">{$LANG.noteAttributes}</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col__5">
                        <input type="checkbox" name="notes_as_description" id="notesAsDescId" tabindex="90"
                                {if $product.notes_as_description == 'Y'} checked {/if} value='true'/>
                    </div>
                    <div class="col__95">
                        <label for="notesAsDescId" style="padding-top: 0">{$LANG.noteAsDescription}</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col__5">
                        <input type="checkbox" name="show_description" id="showDescId" tabindex="100"
                                {if $product.show_description == 'Y'} checked {/if} value="true"/>
                    </div>
                    <div class="col__95">
                        <label for="showDescId" style="padding-top: 0">{$LANG.noteExpand}</label>
                    </div>
                </div>
            </div>
