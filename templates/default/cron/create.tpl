...
{else}
    <form name="frmpost" method="POST" id="frmpost" action="index.php?module=cron&amp;view=create">
        <div class="flex__area">
            ...
            <div class="flex__container flex__start">
                <label for="startdate" class="margin__right-1">{$LANG.startDate}:</label>
            ...
            <div class="flex__container flex__start">
                <label for="enddate" class="margin__right-1">{$LANG.endDate}:</label>
            ...
            <div class="flex__container flex__start">
                <label for="recurrenceId" class="margin__right-1">{$LANG.recurEach}:</label>
                <input name="recurrence" id="recurrenceId" class="validateWholeNumber" required tabindex="40"
                       {if isset($smarty.post.recurrence)}value="{$smarty.post.recurrence|utilNumberTrim:0}"{/if}/>
                <!--suppress HtmlFormInputWithoutLabel -->
                <select name="recurrence_type" class="margin__left-0-5" required tabindex="50">
                    <option value="day"
            ...
            <div class="flex__container flex__start">
                <label for="emailBillerId" class="margin__right-1">{$LANG.emailBillerAfterCron}:</label>
            ...
            <div class="flex__container flex__start">
                <label for="emailCustomerId" class="margin__right-1">{$LANG.emailCustomerAfterCron}:</label>
