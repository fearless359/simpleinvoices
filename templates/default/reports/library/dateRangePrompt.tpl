...
<div class="grid__container grid__head-10">
    <label for="startDateId" class="cols__2-span-3 align__text-right margin__right-1">{$LANG.startDate}:</label>
...
<div class="grid__container grid__head-10">
    <label for="endDateId" class="cols__2-span-3 align__text-right margin__right-1">{$LANG.endDate}:</label>
