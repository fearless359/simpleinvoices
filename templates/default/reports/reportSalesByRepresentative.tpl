...
<h2 class="si_report_title">{$LANG.salesRepresentative} {$LANG.reportUc}</h2>
{if $menu}
    <div class="welcome">
...
{if isset($smarty.post.submit) || $view == export}
    ...
    {if $filter_by_date == "yes"}
        <div class="align_left"><strong>{$LANG.selectionPeriod} {if isset($start_date)}{$start_date}{/if} {$LANG.to} {if isset($end_date)}{$end_date}{/if}</strong></div>
        <br/>
    {/if}
    <table style="width:100%;">
        <tr>
            <td style="width:75%;">
                <strong>{$LANG.salesRepresentative}:</strong> {if isset($sales_rep)}{$sales_rep}{/if}
                <br/>
                <br/>
            </td>
            <td style="width:25%;">
    ...
    <table class="center" style="width:100%;">
        <tr>
            ...
            <td>&nbsp;&nbsp;</td>
            <td class="details_screen"><b>{$LANG.dateUc}</b></td>
            <td>&nbsp;&nbsp;</td>
