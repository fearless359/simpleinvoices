...
{if isset($smarty.post.submit)}
    ...
    <br/>
    <br/>
    {$LANG.saveInvoiceItemsSuccess};
    <br/>
    <br/>
{else}
    <div id="top"><h3>{$LANG.addInvoiceItem}</h3></div>
    ...
    <form name="add_invoice_item" action="index.php?module=invoices&amp;view=add_invoice_item" method="post">
        <table>
            ...
            <tr>
                <td class="details_screen">{$LANG.productUc}</td>
                <td>
            ...
            <tr>
                <td class="details_screen">{$LANG.unitPrice}</td>
                <td>
            ...
            {if $type == 3}
                <tr>
                    <td class="details_screen" colspan="2">{$LANG.descriptionUc}</td>
                </tr>
                <tr>
                    <td colspan="2">
                        <!--
        ...
        <div style="text-align:center;">
            <input type="submit" name="submit" value="{$LANG.addItem}"/>
