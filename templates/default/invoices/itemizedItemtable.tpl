<div class="grid__area">
    <div class="grid__container grid__head-10">
        <div class="cols__1-span-1 bold align__text-right">
            <label for="quantity0" class="align__text-right">{$LANG.quantityShort}
        ...
        {section name=taxHeader loop=$defaults.tax_per_line_item }
            {$taxNumber = $smarty.section.taxHeader.index}
            <div class="cols__{$begCol}-span-1 margin__left-1 bold align__text-center">
                <label for="tax_id[0][{$taxNumber|htmlSafe}]">
                    {$LANG.tax} {if $defaults.tax_per_line_item > 1}{$smarty.section.taxHeader.iteration|htmlSafe}{/if}
                </label>
            </div>
            {$begCol = $begCol + 1}
        {/section}
        <div class="cols__{$begCol}-span-1 bold margin__left-1 align__text-right">
                ...
                <div class="grid__container grid__head-10">
                    <div class="cols__1-span-1">
                        ...
                        <div id="qtyColumn" style="display:grid;grid-template-columns: {$cols};">
                            <a class="delete_link" id="delete_link{$line|htmlSafe}" href="#"
                               title="{$LANG.deleteLineItem}"
