...
<div class="grid__container grid__head-10">
    <label for="preferenceId" class="cols__1-span-2 bold si_label">{$LANG.invPref}:</label>
    ...
    <label for="salesRepresentative" class="cols__6-span-2 bold si_label">{$LANG.salesRepresentative}:</label>
