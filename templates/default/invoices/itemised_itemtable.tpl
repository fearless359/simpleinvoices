        ...
        <tr class="details si_hide">
            ...
            <td colspan="4">
                 <textarea class="detail" name="description{$lineNumber|htmlsafe}" id="description{$lineNumber|htmlsafe}"
                           rows="4" cols="60" data_description="{$LANG['description']}">{if isset($defaultInvoiceItems[$lineNumber].description)}{$defaultInvoiceItems[$lineNumber].description|htmlsafe}{/if}</textarea>
