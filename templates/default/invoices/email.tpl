 ...
 *
 *  Last edited:
 *      20260216 by Rich Rowley to use column size layout for responsiveness and appearence.
...
{if $smarty.get.stage == 1 }
    ...
    <div class="form__container">
        <h3 class="align__text-center margin__bottom-3">{$LANG.email} {$invoice.index_name|htmlSafe} {$LANG.to} {$LANG.customerUc} {$LANG.asLc} {$LANG.pdf}</h3>
        <form name="frmpost" method="POST" id="frmpost"
            ...
            <div class="row">
                <div class="col__30">
                    <label for="emailFrom" class="cols__1-span-2">
                        {$LANG.emailFrom}:
                        <img class="tooltip" title="{$LANG.requiredField} {$LANG.helpEmailFrom}"
            ...
            <div class="row">
                <div class="col__30">
                    <label for="emailTo" class="cols__1-span-2">{$LANG.emailTo}:
                        <img class="tooltip" title="{$LANG.requiredField} {$LANG.helpEmailTo}"
                             src="{$helpImagePath}required-small.png" alt=""/>
                    </label>
                </div>
                <div class="col__70">
            ...
            <div class="row">
                <div class="col__30">
                    <label for="emailBcc" class="cols__1-span-2">{$LANG.emailBcc}:
                        <img class="tooltip" title="{$LANG.helpEmailBcc}" src="{$helpImagePath}help-small.png"
                             alt=""/>
                    </label>
                </div>
                <div class="col__70">
                    <input type="text" name="emailBcc" id="emailBcc" class="margin__left-0-5" size="50"
                           value="{if isset($biller.email)}{$biller.email|htmlSafe}{/if}" tabindex="30"/>
                </div>
            </div>
            <div class="row">
                <div class="col__30">
                    <label for="emailSubject" class="cols__1-span-2">{$LANG.subject}:
                        <img class="tooltip" title="{$LANG.requiredField} {$LANG.helpRequiredField}"
                             src="{$helpImagePath}required-small.png" alt=""/>
                    </label>
                </div>
                <div class="col__70">
                    <input type="text" name="emailSubject" id="emailSubject" size="70" class="margin__left-0-5"
                           required
                           tabindex="40"
            ...
            <div class="row">
                <div class="col__100">
                    <input name="emailNotes" id="emailNotes"
                           {if isset($biller.signature)}value="{$biller.signature|outHtml}"{/if} type="hidden">
