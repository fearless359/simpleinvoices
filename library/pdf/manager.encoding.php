...
class ManagerEncoding
{
    ...
    public function toUTF8($word, $encoding)
    {
    ...
    public function getMapping($char)
    {
    ...
    public function _loadMapping($mapping_file)
    {
    ...
    public function _generateMapping($mapping_file)
    {
    ...
    public function __construct()
    {
        ...
        $this->registerCustomEncoding("custom", array(
    ...
    public function getCanonizedEncodingName($encoding)
    {
    ...
    public function registerCustomEncoding($name, $vector)
    {
        $this->registerEncoding($name, $vector);
        $this->_custom_vector_name = $name;
    }

    public function getCustomEncodingName()
    {
        return $this->_custom_vector_name;
    }

    public function getCustomEncodingVector()
    {
        return $this->_encodings[$this->getCustomEncodingName()];
    }

    public function registerEncoding($name, $vector)
    {
     ...
     * @return string
     */
    public function addCustomChar($char)
    {
     ...
     */
    public function getEncodingVector($encoding)
    {
    ...
    public function get_encoding_glyphs($encoding)
    {
        $vector = $this->getEncodingVector($encoding);
        if (is_null($vector)) {
    ...
    public function get_glyph_to_code_mapping($encoding)
    {
        $vector = $this->getEncodingVector($encoding);
    ...
    public function vector_to_glyphs($vector)
    {
        $result = array();
    ...
    public function get_ps_encoding_vector($encoding)
    {
        $vector = $this->getEncodingVector($encoding);
    ...
    public function getNextUTF8Char($raw_content, &$ptr)
    {
