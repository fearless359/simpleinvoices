...
class BoxPageMargin extends GenericContainerBox
{
     ...
     */
    public static function &create(&$pipeline, $at_rule)
    {
    ...
    public function __construct(&$pipeline, $at_rule)
    {
    ...
    public function get_cell_baseline()
    {
        return 0;
    }

    public function reflow(&$driver, &$media, $boxes = null)
    {
    ...
    public function _calc_sizes($full_width, $left, $center, $right)
    {
        $context = new FlowContext();
...
{
    public function _position($media, $boxes, $context)
    {
