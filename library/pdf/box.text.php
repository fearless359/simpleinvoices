...
class TextBox extends SimpleInlineBox
{
    ...
    // Added 2018
    public $font_height; // See added below.
    public $font_size;
    public $ascender;
    public $descender;
    public $width;
    ...
    public function __construct()
    {
        ...
        $this->font_height = 0; // Added 20181129 by RCR for reference in box.whitespace.php
        $this->font_size = 0;
        $this->ascender = 0;
        $this->descender = 0;
        $this->width = 0;
     ...
     * @return array
     */
    public function _make_wrappable(&$driver, $base_width, $font_name, $font_size, $subword_index)
    {
    ...
    public function get_content_callback($word, $encoding)
    {
    ...
    public function put_height($value)
    {
        $this->height = $value;
    }
    ...
    //
    public function _apply_line_height()
    {
    ...
    public function _get_font_name(&$viewport, $subword_index)
    {
    ...
    public function add_subword($raw_subword, $encoding, $hyphens)
    {
    ...
    public  static function &create_empty(&$pipeline)
    {
        $box = new TextBox();
    ...
    public function get_descender()
    {
        return $this->descender;
    }

    public function get_ascender()
    {
    ...
    //
    public function maybe_line_break(&$parent, &$context)
    {
    ...
    public function _find_soft_hyphen(&$parent, $width_delta)
    {
        /**
    ...
    public function save_wrapped($wrappable, &$parent, &$context)
    {
    ...
    {
        // Check if we need a line break here (possible several times in a row, if we
        // have a long word and a floating box intersecting with this word
        //
        // To prevent infinite loop, we'll use a limit of 100 sequential line feeds
        $i = 0;
    ...
    public function getWrappedWidthAndHyphen()
    {
        return $this->wrapped[0][3];
    }

    public function getWrappedWidth()
    {
        return $this->wrapped[0][2];
    }

    public function reflow_text(&$driver)
    {
    ...
    public function _showText(&$driver)
    {
        if (!is_null($this->wrapped)) {
    ...
    public function _showTextWrapped(&$driver)
    {
        // draw generic box
        parent::show($driver);
    ...
    public function _showTextNormal(&$driver)
    {
        // draw generic box
        parent::show($driver);
    ...
    public function offset($dx, $dy)
    {
        ...
        // Note that horizontal offset should be called explicitly from text-align routines
    ...
    public function offset_wrapped($dx, $dy)
    {
        $this->wrapped[1] += $dx;
        $this->wrapped[2] += $dy;
    }
