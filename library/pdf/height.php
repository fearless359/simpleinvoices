...
class HCConstraint
{
    ...
    public function applicable(&$box)
    {
     ...
     */
    public function applicable_value($value, &$box)
    {
        return true;
...
//     return $box->parent->_height_constraint->applicable($box->parent);
    ...
    public function _fix_value($value, &$box, $default, $no_table_recursion)
    {
...
//       if (!$box->parent) { return null; }
    ...
    //
    public function __construct($constant, $min, $max)
    {
    ...
    public function apply_min($value, &$box, $no_table_recursion)
    {
        if (is_null($this->min)) {
            return $value;
        } else {
    ...
    public function apply_max($value, &$box, $no_table_recursion)
    {
        if (is_null($this->max)) {
            return $value;
        } else {
    ...
    public function apply($value, &$box, $no_table_recursion = false)
    {
        if (!is_null($this->constant)) {
