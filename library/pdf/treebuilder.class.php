...
class TreeBuilder
{
    public static function build($xmlstring)
    {
        ...
        if (class_exists('DOMDocument')) {
            ...
            // Modified 20181129 by RCR to not call statically.
            $lcl_domDocument = new DOMDocument();
            $lcl_domDocument->loadXML($xmlstring);
            return DOMTree::from_DOMDocument($lcl_domDocument);
        }
