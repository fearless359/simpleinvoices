...
class OpenTypeFile
{
    ...
    public function &_getCMAPSubtable($offset)
    {
        $table =& $this->_sfnt->_getCMAPSubtable($offset, $this->_filehandle, $this);
        return $table;
    }

    public function _read($filehandle)
    {
...
class OpenTypeFileSFNT
{
    ...
    public function &_getCMAPSubtable($offset, $filehandle, $file)
    {
    ...
    public function &_getTable($tag, $filehandle, $file)
    {
    ...
    public function _getDirectory($tag)
    {
    ...
    public function _createTableByTag($tag)
    {
        switch ($tag) {
            case 'hhea':
...
class OpenTypeFileTable
{
    ...
    public function _fixFWord($value)
    {
        if ($value > 65536 / 2) {
            return $value - 65536;
        } else {
    ...
    public function _fixShort($value)
    {
        if ($value > 65536 / 2) {
            return $value - 65536;
        } else {
...
class OpenTypeFileNAME extends OpenTypeFileTable
{
     ...
     */
    public function lookup($platformId, $encodingId, $languageId, $nameId)
    {
...
class OpenTypeFileNAMERecord extends OpenTypeFileTable
{
    ...
    public function setBaseOffset($offset)
    {
        $this->_baseOffset = $offset;
    }

    public function match($platformId, $encodingId, $languageId, $nameId)
    {
        return
...
class OpenTypeFileCMAP extends OpenTypeFileTable
{
     ...
     * of CMAP table
     */
    public function _getSubtable($filehandle, $offset)
    {
        fseek($filehandle, $offset, SEEK_CUR);
    ...
    public function &findSubtable($platformId, $encodingId)
    {
        $file = $this->getFontFile();
    ...
    public function &getSubtable($index)
    {
...
class OpenTypeFileCMAPSubtable
{
    ...
    public function lookup($unicode)
    {
...
class OpenTypeFileCMAPSubtable4 extends OpenTypeFileTable
{
     ...
     */
    public function _lookupSegment($unicode)
    {
