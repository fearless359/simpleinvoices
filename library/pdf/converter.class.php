...
{
    public static function to_utf8($string, $encoding)
    {
...
{
    public static function apply_aliases($encoding)
    {
    ...
    public static function to_utf8($html, $encoding)
    {
        global $g_utf8_converters;

        $encoding = self::apply_aliases($encoding);
        ...
        if ($encoding === 'iso-8859-1') {
            ...
            return self::something_to_utf8($html, $g_utf8_converters[$encoding][0]);
        } else {
            die("Unsupported encoding detected: '$encoding'");
        }
    }

    public static function something_to_utf8($html, &$mapping)
    {
