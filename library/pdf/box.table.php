...
class TableBox extends GenericContainerBox
{
    ...
    public function cols_count()
    {
        return count($this->content[0]->content);
    }

    // FIXME: just a stub
    public function append_line(&$e)
    {
    }
    ...
    public function parse_col(&$root, $index)
    {
    ...
    //
    public function parse_colgroup_tag(&$root, $start_index)
    {
        $index = $start_index;
    ...
    public function normalize_parent()
    {
    ...
    // PREDICATES
    public function is_constrained_column($index)
    {
        return !is_a($this->get_cwc($index), "wcnone");
    }

    // ROWSPANS
    public function table_have_rowspan($x, $y)
    {
        return $this->content[$y]->content[$x]->rowspan;
    }

    public function table_fit_rowspans($heights)
    {
     ...
     */
    public function _row_heights($minheight)
    {
        $heights = array();
        $cheights = array();
    ...
    public function table_resize_rows(&$heights)
    {
    ...
    //   //
    //   public function table_row_height($index) {
    //     // Select row
    ...
    //   public function get_row_baseline($index) {
    //     // Get current row
    //     $row =& $this->content[$index];
    ...
    public function get_max_width_natural(&$context, $limit = 10E6)
    {
    ...
    public function table_column_widths(&$context)
    {
...
//       break;
    ...
    //
    public function _table_apply_colspans($widths, &$context, $width_fun, $minwc, $maxwc)
    {
    ...
    public function get_table_columns_max_widths(&$context)
    {
        ...
        for ($i = 0; $i < count($widths); $i++) {
            ...
            // Nevertheless, percentage constraints should not be applied IF table
    ...
    public function check_constrained_colspan($col)
    {
    ...
    //
    public function normalize_min_widths($width, $minw, $minwc)
    {
    ...
    public function table_have_colspan($x, $y)
    {
    ...
    // and 'false' otherwise
    //
    public function get_non_constrained_flags()
    {
        $flags = array();
    ...
    // and 'false' otherwise
    //
    public function get_non_percentage_constrained_height_flags()
    {
        $flags = array();
    ...
    public function get_non_constrained_height_flags()
    {
        $flags = array();
    ...
    // and 'false' otherwise
    //
    public function get_non_constrained_width_flags()
    {
        $flags = array();
    ...
    public function get_non_constant_constrained_width_flags()
    {
        $flags = array();
    ...
    public function check_if_column_image_constrained($col)
    {
        for ($i = 0; $i < $this->rows_count(); $i++) {
            $cell =& $this->cell($i, $col);
    ...
    public function get_non_image_constrained_width_flags()
    {
        $flags = array();
    ...
    // and 'false' otherwise
    //
    public function get_non_constant_constrained_flags()
    {
        $flags = array();
    ...
    public function reflow_content(&$context)
    {
        // Reflow content
