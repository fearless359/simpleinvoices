...
if (!class_exists('FPDF')) {
    ...
    class PDFIndirectObject
    {
         ...
         */
        public function _out_nested(&$handler)
        {
            return true;
        }
        ...
        public function pdf(&$handler)
        {
            return $handler->_dictionary($this->_dict($handler));
        }

        public function _dict(&$handler)
        {
            return array();
        }
    }
    ...
    class PDFCMap extends PDFIndirectObject
    {
        ...
        public function __construct($mapping, &$handler, $object_id, $generation_id)
        {
...
EOF;
    ...
    class PDFPage extends PDFIndirectObject
    {
        ...
        public function _annotations(&$handler)
        {
    ...
    class PDFRect
    {
        ...
        public function left(&$handler)
        {
            return $handler->x_coord($this->x);
        }

        public function right(&$handler)
        {
            return $handler->x_coord($this->x + $this->w);
        }

        public function top(&$handler)
        {
            return $handler->y_coord($this->y);
        }

        public function bottom(&$handler)
        {
    ...
    class PDFFieldGroup extends PDFIndirectObject
    {
        ...
        public function _check_field_name($field)
        {
            /**
    ...
    class PDFField extends PDFAnnotationWidget
    {
        ...
        public function set_parent(&$form)
        {
            $this->_parent =& $form;
        }
    ...
    class PDFFieldPushButton extends PDFField
    {
        ...
        public function _action(&$handler)
        {
            return "<< >>";
        }
...
//                                                    "/Tx BMC EMC");
    ...
    class FPDF
    {
        ...
        public function is_object_written($id)
        {
            return isset($this->offsets[$id]);
        }

        public function x_coord($x)
        {
            return $x * $this->k;
        }

        public function y_coord($y)
        {
        ...
        //
        public function _indirect_object($object)
        {
        ...
        public function _stream($content)
        {
            return "stream\n" . $content . "\nendstream";
        }
        ...
        public function _dictionary($dict)
        {
            $content = "";
        ...
        public function _array($array_str)
        {
            return "[$array_str]";
        }

        public function _reference(&$object)
        {
        ...
        public function _reference_array($object_array)
        {
            $array_str = "";
/*********************************************************************************************
 *  Added 20181201 by RCR to eliminate issue in print to pdf for Statement of Invoices report.
 */
if (is_array($object_array) || $object_array instanceof Countable) {
    $count = count($object_array);
} else {
    $count = 0;
}
...
/** End of RCR changes */
        ...
        public function _generate_new_object_number()
        {
            $this->n++;
            return $this->n;
        }
        ...
        public function add_field_select($x, $y, $w, $h, $name, $value, $options)
        {
         ...
         */
        public function add_field_checkbox($x, $y, $w, $h, $name, $value, $checked)
        {
        ...
        public function add_field_radio($x, $y, $w, $h, $group_name, $value, $checked)
        {
         ...
         * @return Field number
         */
        public function add_field_text($x, $y, $w, $h, $value, $field_name)
        {
        ...
        public function add_field_multiline_text($x, $y, $w, $h, $value, $field_name)
        {
         ...
         * @return Field number
         */
        public function add_field_password($x, $y, $w, $h, $value, $field_name)
        {
        ...
        public function add_field_pushbuttonimage($x, $y, $w, $h, $field_name, $value, $actionURL)
        {
        ...
        public function add_field_pushbuttonsubmit($x, $y, $w, $h, $field_name, $value, $actionURL)
        {
        ...
        public function add_field_pushbuttonreset($x, $y, $w, $h)
        {
        ...
        public function add_field_pushbutton($x, $y, $w, $h)
        {
        ...
        public function _dostrikeout($x, $y, $txt)
        {
            $bbox = $this->_GetFontBBox();
        ...
        public function SetDecoration($underline, $overline, $strikeout)
        {
        ...
        public function _LoadFont($fontkey, $family, $encoding)
        {
        ...
        public function _MakeFontKey($family, $encoding)
        {
            return $family . '-' . $encoding;
        }

        public function GetFontAscender($name, $encoding)
        {
        ...
        public function GetFontDescender($name, $encoding)
        {
            $fontkey = $this->_MakeFontKey($name, $encoding);
            $this->_LoadFont($fontkey, $name, $encoding, '');
        ...
        public function SetTextRendering($mode)
        {
        ...
        public function setup_format($width, $height)
        {
         ...
         */
        public function AddFont($fontkey, $family, $encoding, $file, $bEmbed)
        {
            if (isset($this->fonts[$fontkey])) {
            ...
            if ($diff) {
                ...
                if ($d == 0) {
                     ...
                     */
                    $this->cmaps[$d] = new PDFCMap($cmap, $handler,
                        $this->_generate_new_object_number(),
                        0);
                }
         ...
         */
        public function SetFont($family, $encoding, $size)
        {
         ...
         */
        public function add_link_external($x, $y, $w, $h, $link)
        {
         ...
         */
        public function add_link_internal($x, $y, $w, $h, $link)
        {
 ...
 *  Added 20181201 by RCR to eliminate issue in print to pdf for Statement of Invoices report.
 */
if (is_array($annotations) || $annotations instanceof Countable) {
...
/** End of RCR changes */
        ...
        public function _putcatalog($pages_start_obj_number)
        {
