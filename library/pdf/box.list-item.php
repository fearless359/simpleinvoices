...
class ListItemBox extends BlockBox
{
    ...
    public function __construct(&$root, &$pipeline)
    {
    ...
    public function get_marker_box_width()
    {
        $list_style = $this->getCSSProperty(CSS_LIST_STYLE);
    ...
    public function mb_string(&$viewport, $x, $y)
    {
    ...
    public function mb_disc(&$viewport, $x, $y)
    {
    ...
    public function mb_circle(&$viewport, $x, $y)
    {
        $color = $this->getCSSProperty(CSS_COLOR);
        $color->apply($viewport);
    ...
    public function mb_square(&$viewport, $x, $y)
    {
        $color = $this->getCSSProperty(CSS_COLOR);
        $color->apply($viewport);
    ...
    public function mb_image(&$viewport, $x, $y)
    {
        $font = $this->getCSSProperty(CSS_FONT);
