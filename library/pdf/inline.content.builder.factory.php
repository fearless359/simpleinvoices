...
class InlineContentBuilderFactory
{
    /**
     * @param $whitespace
     * @return InlineContentBuilderNormal|InlineContentBuilderNowrap|InlineContentBuilderPre|InlineContentBuilderPreLine|InlineContentBuilderPreWrap
     */
    public static function &get($whitespace)
    {
        $builder = null;
        switch ($whitespace) {
