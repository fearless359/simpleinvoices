...
if ($eWAY_CustomerID || $eWAY_PaymentMethod || $eWAY_UseLive) {} // eliminates unused warning
...
class Ewaylib {
    ...
    function sendTransactionToEway($xmlRequest) {
        ...
        if(curl_errno( $ch ) == CURLE_OK) return $xmlResponse;
    }
    ...
    function parseResponse($xmlResponse){
        ...
        foreach($xmlData as $data) {
            if($data["level"] == 2) $responseFields[$data["tag"]] = $data["value"];
        }
        return $responseFields;
    }
